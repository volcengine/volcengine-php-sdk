...
class BudgetAlertMessageForCreateBudgetInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetAlertMessageForCreateBudgetInput';
