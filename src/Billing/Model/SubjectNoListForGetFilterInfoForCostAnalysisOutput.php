...
class SubjectNoListForGetFilterInfoForCostAnalysisOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubjectNoListForGetFilterInfoForCostAnalysisOutput';
