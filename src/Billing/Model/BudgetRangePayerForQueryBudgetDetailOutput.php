...
class BudgetRangePayerForQueryBudgetDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetRangePayerForQueryBudgetDetailOutput';
