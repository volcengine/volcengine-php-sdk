...
class ChargeItemForPreCheckDropShippingOrderInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeItemForPreCheckDropShippingOrderInput';
