...
class ProductListForGetFilterInfoForCostAnalysisOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductListForGetFilterInfoForCostAnalysisOutput';
