...
class BudgetRangeProductForQueryBudgetDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetRangeProductForQueryBudgetDetailOutput';
