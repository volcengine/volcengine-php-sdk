...
class ConfigurationCodeForGetFilterInfoForCostAnalysisOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfigurationCodeForGetFilterInfoForCostAnalysisOutput';
    ...
    {
        return $this->container['config_code'];
    }

    /**
     * Sets config_code
     *
     * @param string $config_code config_code
     *
     * @return $this
     */
    public function setConfigCode($config_code)
    {
        $this->container['config_code'] = $config_code;
