...
class BudgetRangeOwnerForQueryBudgetDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetRangeOwnerForQueryBudgetDetailOutput';
