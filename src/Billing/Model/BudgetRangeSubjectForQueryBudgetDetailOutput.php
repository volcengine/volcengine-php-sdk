...
class BudgetRangeSubjectForQueryBudgetDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetRangeSubjectForQueryBudgetDetailOutput';
