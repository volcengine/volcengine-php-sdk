...
class ChargeItemForGetDropShippingOrderOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeItemForGetDropShippingOrderOutput';
