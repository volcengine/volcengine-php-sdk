...
class BudgetAlertRuleListForQueryBudgetDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BudgetAlertRuleListForQueryBudgetDetailOutput';
