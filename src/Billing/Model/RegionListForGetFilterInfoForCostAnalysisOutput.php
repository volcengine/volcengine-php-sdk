...
class RegionListForGetFilterInfoForCostAnalysisOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionListForGetFilterInfoForCostAnalysisOutput';
