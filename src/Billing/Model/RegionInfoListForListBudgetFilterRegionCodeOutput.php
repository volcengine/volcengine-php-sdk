...
class RegionInfoListForListBudgetFilterRegionCodeOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionInfoListForListBudgetFilterRegionCodeOutput';
