...
class TemplateParamForCreateParameterTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TemplateParamForCreateParameterTemplateInput';
