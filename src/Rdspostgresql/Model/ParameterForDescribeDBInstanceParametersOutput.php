...
class ParameterForDescribeDBInstanceParametersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParameterForDescribeDBInstanceParametersOutput';
