...
class EstimationResultForModifyDBInstanceSpecOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EstimationResultForModifyDBInstanceSpecOutput';
