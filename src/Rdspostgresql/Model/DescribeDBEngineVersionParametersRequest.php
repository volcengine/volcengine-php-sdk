...
class DescribeDBEngineVersionParametersRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeDBEngineVersionParametersRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['db_engine'] === null) {
            $invalidProperties[] = "'db_engine' can't be null";
        }
