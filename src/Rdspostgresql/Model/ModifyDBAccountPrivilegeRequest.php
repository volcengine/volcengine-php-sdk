...
class ModifyDBAccountPrivilegeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyDBAccountPrivilegeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account_privileges'] === null) {
            $invalidProperties[] = "'account_privileges' can't be null";
        }
