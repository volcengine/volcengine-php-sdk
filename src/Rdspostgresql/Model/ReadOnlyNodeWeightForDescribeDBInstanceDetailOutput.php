...
class ReadOnlyNodeWeightForDescribeDBInstanceDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReadOnlyNodeWeightForDescribeDBInstanceDetailOutput';
