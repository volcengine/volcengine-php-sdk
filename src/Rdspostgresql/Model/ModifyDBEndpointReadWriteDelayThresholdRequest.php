...
class ModifyDBEndpointReadWriteDelayThresholdRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyDBEndpointReadWriteDelayThresholdRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['read_only_node_max_delay_time'] === null) {
            $invalidProperties[] = "'read_only_node_max_delay_time' can't be null";
        }
