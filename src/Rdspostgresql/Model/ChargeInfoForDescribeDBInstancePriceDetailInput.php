...
class ChargeInfoForDescribeDBInstancePriceDetailInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeInfoForDescribeDBInstancePriceDetailInput';
