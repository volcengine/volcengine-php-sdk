...
class ParameterForDescribeDBInstanceProxyParametersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParameterForDescribeDBInstanceProxyParametersOutput';
