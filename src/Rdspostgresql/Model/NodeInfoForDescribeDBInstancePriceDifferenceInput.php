...
class NodeInfoForDescribeDBInstancePriceDifferenceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeInfoForDescribeDBInstancePriceDifferenceInput';
