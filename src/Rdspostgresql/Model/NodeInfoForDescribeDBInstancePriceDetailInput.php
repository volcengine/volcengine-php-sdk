...
class NodeInfoForDescribeDBInstancePriceDetailInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeInfoForDescribeDBInstancePriceDetailInput';
