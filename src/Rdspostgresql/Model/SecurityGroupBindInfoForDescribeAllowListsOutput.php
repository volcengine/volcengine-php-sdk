...
class SecurityGroupBindInfoForDescribeAllowListsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecurityGroupBindInfoForDescribeAllowListsOutput';
