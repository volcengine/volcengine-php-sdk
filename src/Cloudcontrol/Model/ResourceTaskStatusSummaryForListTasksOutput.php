...
class ResourceTaskStatusSummaryForListTasksOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceTaskStatusSummaryForListTasksOutput';
