...
class FoundationModelForCreateModelCustomizationJobInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FoundationModelForCreateModelCustomizationJobInput';
