...
class FoundationModelForListModelCustomizationJobsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FoundationModelForListModelCustomizationJobsOutput';
