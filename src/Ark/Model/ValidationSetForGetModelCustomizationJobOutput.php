...
class ValidationSetForGetModelCustomizationJobOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ValidationSetForGetModelCustomizationJobOutput';
