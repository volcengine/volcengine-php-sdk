...
class TosLocationForCreateEvaluationJobInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TosLocationForCreateEvaluationJobInput';
