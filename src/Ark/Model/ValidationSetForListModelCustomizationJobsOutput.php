...
class ValidationSetForListModelCustomizationJobsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ValidationSetForListModelCustomizationJobsOutput';
