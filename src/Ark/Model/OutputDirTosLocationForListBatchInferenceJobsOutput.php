...
class OutputDirTosLocationForListBatchInferenceJobsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutputDirTosLocationForListBatchInferenceJobsOutput';
