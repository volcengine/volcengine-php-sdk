...
class FoundationModelForGetModelCustomizationJobOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FoundationModelForGetModelCustomizationJobOutput';
