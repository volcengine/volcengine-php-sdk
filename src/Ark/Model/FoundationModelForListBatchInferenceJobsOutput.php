...
class FoundationModelForListBatchInferenceJobsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FoundationModelForListBatchInferenceJobsOutput';
