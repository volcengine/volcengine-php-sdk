...
class DatasetForGetModelCustomizationJobOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DatasetForGetModelCustomizationJobOutput';
