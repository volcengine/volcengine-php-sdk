...
class FoundationModelForListEndpointsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FoundationModelForListEndpointsOutput';
