...
class OutputDirTosLocationForCreateBatchInferenceJobInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutputDirTosLocationForCreateBatchInferenceJobInput';
