...
class FoundationModelForCreateEndpointInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FoundationModelForCreateEndpointInput';
