...
class ConditionForDescribeAlertStrategyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionForDescribeAlertStrategyOutput';
