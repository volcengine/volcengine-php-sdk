...
class PaginationForDescribeCdnAccessLogInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginationForDescribeCdnAccessLogInput';
