...
class DomainSyncStatusStateForListCloudAccountsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DomainSyncStatusStateForListCloudAccountsOutput';
