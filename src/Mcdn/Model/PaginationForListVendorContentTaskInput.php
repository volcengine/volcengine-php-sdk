...
class PaginationForListVendorContentTaskInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginationForListVendorContentTaskInput';
