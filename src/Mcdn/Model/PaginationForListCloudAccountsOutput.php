...
class PaginationForListCloudAccountsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginationForListCloudAccountsOutput';
