...
class PaginationForDescribeCdnAccessLogOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginationForDescribeCdnAccessLogOutput';
