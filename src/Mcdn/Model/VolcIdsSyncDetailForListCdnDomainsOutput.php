...
class VolcIdsSyncDetailForListCdnDomainsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VolcIdsSyncDetailForListCdnDomainsOutput';
