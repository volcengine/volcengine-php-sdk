...
class CreateNumberPoolRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateNumberPoolRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sub_service_type'] === null) {
            $invalidProperties[] = "'sub_service_type' can't be null";
        }
