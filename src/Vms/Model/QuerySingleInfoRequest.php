...
class QuerySingleInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QuerySingleInfoRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['single_open_id'] === null) {
            $invalidProperties[] = "'single_open_id' can't be null";
        }
