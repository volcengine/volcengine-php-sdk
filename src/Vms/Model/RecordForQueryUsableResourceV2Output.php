...
class RecordForQueryUsableResourceV2Output implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecordForQueryUsableResourceV2Output';
