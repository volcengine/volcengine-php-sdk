...
class SuccessListForSingleBatchAppendOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SuccessListForSingleBatchAppendOutput';
