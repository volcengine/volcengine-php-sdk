...
class FixedResponseConfigForCreateRulesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FixedResponseConfigForCreateRulesInput';
