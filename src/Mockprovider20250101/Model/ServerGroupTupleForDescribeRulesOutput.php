...
class ServerGroupTupleForDescribeRulesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerGroupTupleForDescribeRulesOutput';
