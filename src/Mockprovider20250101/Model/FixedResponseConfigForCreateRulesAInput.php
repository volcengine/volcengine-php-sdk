...
class FixedResponseConfigForCreateRulesAInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FixedResponseConfigForCreateRulesAInput';
