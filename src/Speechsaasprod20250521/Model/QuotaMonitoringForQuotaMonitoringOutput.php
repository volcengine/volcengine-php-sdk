...
class QuotaMonitoringForQuotaMonitoringOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QuotaMonitoringForQuotaMonitoringOutput';
