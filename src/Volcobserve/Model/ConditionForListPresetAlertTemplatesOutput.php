...
class ConditionForListPresetAlertTemplatesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionForListPresetAlertTemplatesOutput';
