...
class ProjectConditionForCreateObjectGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectConditionForCreateObjectGroupInput';
