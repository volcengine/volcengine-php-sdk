...
class NotifyTemplateForListNotificationsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotifyTemplateForListNotificationsOutput';
