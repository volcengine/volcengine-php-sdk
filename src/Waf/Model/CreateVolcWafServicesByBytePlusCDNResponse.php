...
class CreateVolcWafServicesByBytePlusCDNResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateVolcWafServicesByBytePlusCDNResponse';
