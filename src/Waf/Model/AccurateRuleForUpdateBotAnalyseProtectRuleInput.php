...
class AccurateRuleForUpdateBotAnalyseProtectRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForUpdateBotAnalyseProtectRuleInput';
