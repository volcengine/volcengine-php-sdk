...
class AccurateRuleForListBotAnalyseProtectRuleOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForListBotAnalyseProtectRuleOutput';
