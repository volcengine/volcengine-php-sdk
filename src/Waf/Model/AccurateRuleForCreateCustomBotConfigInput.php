...
class AccurateRuleForCreateCustomBotConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForCreateCustomBotConfigInput';
