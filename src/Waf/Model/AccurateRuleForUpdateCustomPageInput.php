...
class AccurateRuleForUpdateCustomPageInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForUpdateCustomPageInput';
