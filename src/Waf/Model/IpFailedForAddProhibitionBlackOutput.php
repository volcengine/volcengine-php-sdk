...
class IpFailedForAddProhibitionBlackOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpFailedForAddProhibitionBlackOutput';
