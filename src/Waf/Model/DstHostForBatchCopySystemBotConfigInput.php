...
class DstHostForBatchCopySystemBotConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DstHostForBatchCopySystemBotConfigInput';
