...
class QueryAttackAnalysisWithRuleAggLbRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryAttackAnalysisWithRuleAggLbRequest';
