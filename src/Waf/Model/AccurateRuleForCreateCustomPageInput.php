...
class AccurateRuleForCreateCustomPageInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForCreateCustomPageInput';
