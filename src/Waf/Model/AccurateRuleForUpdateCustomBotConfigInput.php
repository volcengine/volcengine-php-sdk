...
class AccurateRuleForUpdateCustomBotConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForUpdateCustomBotConfigInput';
