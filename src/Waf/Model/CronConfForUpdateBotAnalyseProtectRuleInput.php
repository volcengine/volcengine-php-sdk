...
class CronConfForUpdateBotAnalyseProtectRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CronConfForUpdateBotAnalyseProtectRuleInput';
