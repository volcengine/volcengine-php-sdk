...
class AccurateRuleForListCustomBotConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForListCustomBotConfigOutput';
