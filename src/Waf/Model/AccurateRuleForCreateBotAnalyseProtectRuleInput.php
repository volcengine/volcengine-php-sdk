...
class AccurateRuleForCreateBotAnalyseProtectRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccurateRuleForCreateBotAnalyseProtectRuleInput';
