...
class SystemRuleSwitchForUpdateCustomSystemVulRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SystemRuleSwitchForUpdateCustomSystemVulRuleInput';
