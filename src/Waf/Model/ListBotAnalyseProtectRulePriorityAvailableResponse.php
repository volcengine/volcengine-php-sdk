...
class ListBotAnalyseProtectRulePriorityAvailableResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListBotAnalyseProtectRulePriorityAvailableResponse';
