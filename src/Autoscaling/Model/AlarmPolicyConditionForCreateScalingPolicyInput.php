...
class AlarmPolicyConditionForCreateScalingPolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlarmPolicyConditionForCreateScalingPolicyInput';
