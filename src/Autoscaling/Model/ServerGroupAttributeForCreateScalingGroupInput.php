...
class ServerGroupAttributeForCreateScalingGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerGroupAttributeForCreateScalingGroupInput';
