...
class DeleteNotificationConfigurationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteNotificationConfigurationRequest';
