...
class ScheduledPolicyForModifyScalingPolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScheduledPolicyForModifyScalingPolicyInput';
