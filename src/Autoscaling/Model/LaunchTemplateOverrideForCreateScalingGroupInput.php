...
class LaunchTemplateOverrideForCreateScalingGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LaunchTemplateOverrideForCreateScalingGroupInput';
