...
class VolumeForModifyScalingConfigurationInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VolumeForModifyScalingConfigurationInput';
