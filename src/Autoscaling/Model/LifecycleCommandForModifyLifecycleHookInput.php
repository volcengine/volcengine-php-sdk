...
class LifecycleCommandForModifyLifecycleHookInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LifecycleCommandForModifyLifecycleHookInput';
