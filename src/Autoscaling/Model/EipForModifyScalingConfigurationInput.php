...
class EipForModifyScalingConfigurationInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipForModifyScalingConfigurationInput';
