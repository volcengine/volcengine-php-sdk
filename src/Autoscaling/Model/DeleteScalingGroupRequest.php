...
class DeleteScalingGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteScalingGroupRequest';
     ...
     * @return bool
     */
    public function getKeepInstance()
    {
        return $this->container['keep_instance'];
    }

    /**
     * Sets keep_instance
     *
     * @param bool $keep_instance keep_instance
     *
     * @return $this
     */
    public function setKeepInstance($keep_instance)
    {
        $this->container['keep_instance'] = $keep_instance;
