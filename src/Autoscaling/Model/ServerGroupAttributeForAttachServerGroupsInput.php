...
class ServerGroupAttributeForAttachServerGroupsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerGroupAttributeForAttachServerGroupsInput';
