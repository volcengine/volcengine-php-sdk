...
class LifecycleCommandForDescribeLifecycleHooksOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LifecycleCommandForDescribeLifecycleHooksOutput';
