...
class AlarmPolicyConditionForModifyScalingPolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlarmPolicyConditionForModifyScalingPolicyInput';
