...
class LaunchTemplateOverrideForModifyScalingGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LaunchTemplateOverrideForModifyScalingGroupInput';
