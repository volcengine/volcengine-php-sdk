...
class ConditionForDescribeScalingPoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionForDescribeScalingPoliciesOutput';
