...
class FillColorForUpdateVideoAnalysisTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForUpdateVideoAnalysisTaskOutput';
