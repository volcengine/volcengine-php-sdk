...
class FillColorForGetVideoAnalysisTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForGetVideoAnalysisTaskOutput';
