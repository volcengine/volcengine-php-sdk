...
class NodeInfoForListNodeGroupOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'nodeInfoForListNodeGroupOutput';
     ...
     * Sets node_status
     *
     * @param int $node_status node_status
     *
     * @return $this
     */
