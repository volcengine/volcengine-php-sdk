...
class FillColorForStopVideoStreamAnalysisTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForStopVideoStreamAnalysisTaskOutput';
