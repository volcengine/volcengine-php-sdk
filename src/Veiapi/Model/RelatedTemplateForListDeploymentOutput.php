...
class RelatedTemplateForListDeploymentOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'related_templateForListDeploymentOutput';
