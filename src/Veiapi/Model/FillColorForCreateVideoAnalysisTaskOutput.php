...
class FillColorForCreateVideoAnalysisTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForCreateVideoAnalysisTaskOutput';
