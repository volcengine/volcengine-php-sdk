...
class FillColorForCreateVideoAnalysisTaskInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForCreateVideoAnalysisTaskInput';
