...
class FillColorForCommitVideoAnalysisTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForCommitVideoAnalysisTaskOutput';
