...
class FillColorForUpdateVideoAnalysisTaskInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForUpdateVideoAnalysisTaskInput';
