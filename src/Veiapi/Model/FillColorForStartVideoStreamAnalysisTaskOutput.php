...
class FillColorForStartVideoStreamAnalysisTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fill_colorForStartVideoStreamAnalysisTaskOutput';
