...
class FilterForSearchMultiAccountResourcesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FilterForSearchMultiAccountResourcesInput';
