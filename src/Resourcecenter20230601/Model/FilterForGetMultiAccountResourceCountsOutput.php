...
class FilterForGetMultiAccountResourceCountsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FilterForGetMultiAccountResourceCountsOutput';
