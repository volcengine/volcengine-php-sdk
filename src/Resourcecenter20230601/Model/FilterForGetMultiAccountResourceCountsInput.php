...
class FilterForGetMultiAccountResourceCountsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FilterForGetMultiAccountResourceCountsInput';
