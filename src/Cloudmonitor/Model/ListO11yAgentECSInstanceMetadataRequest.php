...
class ListO11yAgentECSInstanceMetadataRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListO11yAgentECSInstanceMetadataRequest';
