...
class NotifyTemplateForListRulesByIdsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotifyTemplateForListRulesByIdsOutput';
