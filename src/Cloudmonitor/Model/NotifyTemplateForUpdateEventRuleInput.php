...
class NotifyTemplateForUpdateEventRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotifyTemplateForUpdateEventRuleInput';
