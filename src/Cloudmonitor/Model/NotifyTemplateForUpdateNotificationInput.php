...
class NotifyTemplateForUpdateNotificationInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotifyTemplateForUpdateNotificationInput';
