...
class NotifyTemplateForCreateEventRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NotifyTemplateForCreateEventRuleInput';
