...
class ProjectConditionForListRulesByIdsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectConditionForListRulesByIdsOutput';
