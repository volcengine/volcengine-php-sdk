...
class ConfigureNodeForEnableDBInstanceHAInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfigureNodeForEnableDBInstanceHAInput';
