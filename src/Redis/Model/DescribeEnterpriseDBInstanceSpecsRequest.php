...
class DescribeEnterpriseDBInstanceSpecsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeEnterpriseDBInstanceSpecsRequest';
