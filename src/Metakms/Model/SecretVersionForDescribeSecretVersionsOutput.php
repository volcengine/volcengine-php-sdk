...
class SecretVersionForDescribeSecretVersionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecretVersionForDescribeSecretVersionsOutput';
