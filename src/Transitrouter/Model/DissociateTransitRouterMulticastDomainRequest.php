...
class DissociateTransitRouterMulticastDomainRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DissociateTransitRouterMulticastDomainRequest';
