...
class DeleteTransitRouterTrafficQosMarkingEntryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteTransitRouterTrafficQosMarkingEntryRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transit_router_traffic_qos_marking_entry_id'] === null) {
            $invalidProperties[] = "'transit_router_traffic_qos_marking_entry_id' can't be null";
        }
