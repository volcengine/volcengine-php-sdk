...
class DeleteTransitRouterVpcAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteTransitRouterVpcAttachmentRequest';
