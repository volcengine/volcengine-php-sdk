...
class ModifyTransitRouterVpnAttachmentAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyTransitRouterVpnAttachmentAttributesRequest';
