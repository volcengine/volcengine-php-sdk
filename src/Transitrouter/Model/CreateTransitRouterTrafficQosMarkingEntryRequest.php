...
class CreateTransitRouterTrafficQosMarkingEntryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTransitRouterTrafficQosMarkingEntryRequest';
