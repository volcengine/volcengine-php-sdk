...
class CreateTransitRouterTrafficQosMarkingEntryResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTransitRouterTrafficQosMarkingEntryResponse';
