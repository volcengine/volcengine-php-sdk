...
class EnableTransitRouterRouteTablePropagationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnableTransitRouterRouteTablePropagationRequest';
