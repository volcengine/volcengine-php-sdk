...
class CreateTransitRouterRoutePolicyTableResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTransitRouterRoutePolicyTableResponse';
