...
class DeleteTransitRouterTrafficQosQueuePolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteTransitRouterTrafficQosQueuePolicyRequest';
