...
class CreateTransitRouterTrafficQosQueuePolicyResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTransitRouterTrafficQosQueuePolicyResponse';
