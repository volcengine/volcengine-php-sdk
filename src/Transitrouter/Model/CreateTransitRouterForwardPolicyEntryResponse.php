...
class CreateTransitRouterForwardPolicyEntryResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTransitRouterForwardPolicyEntryResponse';
