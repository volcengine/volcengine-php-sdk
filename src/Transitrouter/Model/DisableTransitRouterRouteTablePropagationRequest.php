...
class DisableTransitRouterRouteTablePropagationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DisableTransitRouterRouteTablePropagationRequest';
