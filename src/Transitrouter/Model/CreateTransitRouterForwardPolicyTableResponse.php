...
class CreateTransitRouterForwardPolicyTableResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTransitRouterForwardPolicyTableResponse';
