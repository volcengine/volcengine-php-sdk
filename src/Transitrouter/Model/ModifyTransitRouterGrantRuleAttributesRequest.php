...
class ModifyTransitRouterGrantRuleAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyTransitRouterGrantRuleAttributesRequest';
