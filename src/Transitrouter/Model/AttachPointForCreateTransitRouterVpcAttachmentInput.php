...
class AttachPointForCreateTransitRouterVpcAttachmentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AttachPointForCreateTransitRouterVpcAttachmentInput';
