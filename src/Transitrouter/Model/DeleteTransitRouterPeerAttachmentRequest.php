...
class DeleteTransitRouterPeerAttachmentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteTransitRouterPeerAttachmentRequest';
