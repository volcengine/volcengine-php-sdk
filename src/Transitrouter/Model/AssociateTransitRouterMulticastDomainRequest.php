...
class AssociateTransitRouterMulticastDomainRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssociateTransitRouterMulticastDomainRequest';
