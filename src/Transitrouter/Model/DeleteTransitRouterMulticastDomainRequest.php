...
class DeleteTransitRouterMulticastDomainRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteTransitRouterMulticastDomainRequest';
