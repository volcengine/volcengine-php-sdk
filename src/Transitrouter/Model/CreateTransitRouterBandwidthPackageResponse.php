...
class CreateTransitRouterBandwidthPackageResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateTransitRouterBandwidthPackageResponse';
