...
class DeleteTransitRouterTrafficQosMarkingPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteTransitRouterTrafficQosMarkingPolicyRequest';
