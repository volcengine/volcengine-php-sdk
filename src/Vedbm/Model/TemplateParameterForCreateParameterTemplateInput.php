...
class TemplateParameterForCreateParameterTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TemplateParameterForCreateParameterTemplateInput';
