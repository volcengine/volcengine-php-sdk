...
class DescribeDBInstanceParameterChangeHistoryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeDBInstanceParameterChangeHistoryRequest';
