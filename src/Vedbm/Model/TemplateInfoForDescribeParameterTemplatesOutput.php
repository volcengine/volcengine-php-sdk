...
class TemplateInfoForDescribeParameterTemplatesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TemplateInfoForDescribeParameterTemplatesOutput';
