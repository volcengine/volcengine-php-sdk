...
class ModifyDBAccountDescriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyDBAccountDescriptionRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account_desc'] === null) {
            $invalidProperties[] = "'account_desc' can't be null";
        }
