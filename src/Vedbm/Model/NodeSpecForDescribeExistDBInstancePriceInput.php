...
class NodeSpecForDescribeExistDBInstancePriceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeSpecForDescribeExistDBInstancePriceInput';
    ...
    const NODE_TYPE_AP_WORK_NODE = 'APWorkNode';
    const NODE_TYPE_DB_ENGINE = 'DBEngine';
    ...
    {
        return [
            self::NODE_TYPE_AP_WORK_NODE,
            self::NODE_TYPE_DB_ENGINE,
        ];
    }
