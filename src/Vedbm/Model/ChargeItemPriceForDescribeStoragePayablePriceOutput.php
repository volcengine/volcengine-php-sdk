...
class ChargeItemPriceForDescribeStoragePayablePriceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeItemPriceForDescribeStoragePayablePriceOutput';
