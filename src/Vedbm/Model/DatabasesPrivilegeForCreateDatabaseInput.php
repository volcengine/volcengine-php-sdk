...
class DatabasesPrivilegeForCreateDatabaseInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DatabasesPrivilegeForCreateDatabaseInput';
