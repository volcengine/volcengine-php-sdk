...
class OriginLineForDescribeDomainVersionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginLineForDescribeDomainVersionOutput';
