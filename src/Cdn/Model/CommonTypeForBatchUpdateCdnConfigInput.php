...
class CommonTypeForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommonTypeForBatchUpdateCdnConfigInput';
