...
class SpeedLimitTimeForDescribeCdnConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpeedLimitTimeForDescribeCdnConfigOutput';
