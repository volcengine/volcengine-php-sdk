...
class SignCapRuleForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignCapRuleForUpdateDomainVersionInput';
