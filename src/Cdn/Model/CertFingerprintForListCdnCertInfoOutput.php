...
class CertFingerprintForListCdnCertInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CertFingerprintForListCdnCertInfoOutput';
