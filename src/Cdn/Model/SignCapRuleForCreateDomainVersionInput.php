...
class SignCapRuleForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignCapRuleForCreateDomainVersionInput';
