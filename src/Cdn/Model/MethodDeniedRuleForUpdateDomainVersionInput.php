...
class MethodDeniedRuleForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MethodDeniedRuleForUpdateDomainVersionInput';
