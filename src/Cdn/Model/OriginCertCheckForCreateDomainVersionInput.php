...
class OriginCertCheckForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginCertCheckForCreateDomainVersionInput';
