...
class IpSpeedLimitActionForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpSpeedLimitActionForUpdateDomainVersionInput';
