...
class ExpTimeCapRuleForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExpTimeCapRuleForBatchUpdateCdnConfigInput';
