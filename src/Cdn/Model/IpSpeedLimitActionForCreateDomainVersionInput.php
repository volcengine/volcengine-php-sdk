...
class IpSpeedLimitActionForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpSpeedLimitActionForCreateDomainVersionInput';
