...
class QueryStringInstanceForDescribeCdnConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryStringInstanceForDescribeCdnConfigOutput';
