...
class MethodDeniedRuleForAddCdnDomainInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MethodDeniedRuleForAddCdnDomainInput';
