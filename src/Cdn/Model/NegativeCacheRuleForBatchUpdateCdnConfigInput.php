...
class NegativeCacheRuleForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NegativeCacheRuleForBatchUpdateCdnConfigInput';
