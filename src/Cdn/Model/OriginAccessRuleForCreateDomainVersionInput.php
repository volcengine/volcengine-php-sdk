...
class OriginAccessRuleForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginAccessRuleForCreateDomainVersionInput';
