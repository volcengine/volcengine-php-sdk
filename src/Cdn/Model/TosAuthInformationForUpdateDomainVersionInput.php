...
class TosAuthInformationForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TosAuthInformationForUpdateDomainVersionInput';
