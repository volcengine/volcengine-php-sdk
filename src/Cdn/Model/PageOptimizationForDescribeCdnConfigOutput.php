...
class PageOptimizationForDescribeCdnConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PageOptimizationForDescribeCdnConfigOutput';
