...
class OfflineCacheForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OfflineCacheForUpdateDomainVersionInput';
