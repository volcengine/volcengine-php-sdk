...
class AuthModeConfigForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthModeConfigForBatchUpdateCdnConfigInput';
