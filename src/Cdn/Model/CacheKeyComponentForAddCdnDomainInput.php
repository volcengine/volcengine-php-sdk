...
class CacheKeyComponentForAddCdnDomainInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CacheKeyComponentForAddCdnDomainInput';
