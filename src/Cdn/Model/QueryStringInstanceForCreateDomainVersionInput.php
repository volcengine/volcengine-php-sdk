...
class QueryStringInstanceForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryStringInstanceForCreateDomainVersionInput';
