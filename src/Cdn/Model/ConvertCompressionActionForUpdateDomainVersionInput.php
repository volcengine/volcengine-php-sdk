...
class ConvertCompressionActionForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertCompressionActionForUpdateDomainVersionInput';
