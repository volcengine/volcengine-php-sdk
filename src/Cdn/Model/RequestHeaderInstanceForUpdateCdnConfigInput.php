...
class RequestHeaderInstanceForUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestHeaderInstanceForUpdateCdnConfigInput';
