...
class AreaAccessRuleForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AreaAccessRuleForCreateDomainVersionInput';
