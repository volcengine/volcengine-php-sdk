...
class BandwidthLimitActionForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BandwidthLimitActionForUpdateDomainVersionInput';
