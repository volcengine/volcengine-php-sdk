...
class CacheKeyComponentForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CacheKeyComponentForBatchUpdateCdnConfigInput';
