...
class DeployResultForBatchDeployCertOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeployResultForBatchDeployCertOutput';
