...
class OriginAccessRuleForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginAccessRuleForUpdateDomainVersionInput';
