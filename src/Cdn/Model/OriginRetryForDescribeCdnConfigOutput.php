...
class OriginRetryForDescribeCdnConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginRetryForDescribeCdnConfigOutput';
