...
class OriginRewriteActionForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginRewriteActionForCreateDomainVersionInput';
