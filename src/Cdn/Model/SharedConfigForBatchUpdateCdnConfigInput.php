...
class SharedConfigForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SharedConfigForBatchUpdateCdnConfigInput';
