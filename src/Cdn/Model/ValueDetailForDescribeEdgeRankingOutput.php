...
class ValueDetailForDescribeEdgeRankingOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ValueDetailForDescribeEdgeRankingOutput';
