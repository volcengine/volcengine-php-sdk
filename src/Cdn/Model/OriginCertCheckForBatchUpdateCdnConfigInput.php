...
class OriginCertCheckForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginCertCheckForBatchUpdateCdnConfigInput';
