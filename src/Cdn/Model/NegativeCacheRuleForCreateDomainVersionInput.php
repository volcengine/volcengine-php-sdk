...
class NegativeCacheRuleForCreateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NegativeCacheRuleForCreateDomainVersionInput';
