...
class SignCapRuleForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignCapRuleForBatchUpdateCdnConfigInput';
