...
class AreaAccessRuleForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AreaAccessRuleForBatchUpdateCdnConfigInput';
