...
class TosAuthInformationForDescribeCdnConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TosAuthInformationForDescribeCdnConfigOutput';
