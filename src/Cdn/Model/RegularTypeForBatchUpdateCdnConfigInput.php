...
class RegularTypeForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegularTypeForBatchUpdateCdnConfigInput';
