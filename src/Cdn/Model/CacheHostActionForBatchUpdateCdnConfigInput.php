...
class CacheHostActionForBatchUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CacheHostActionForBatchUpdateCdnConfigInput';
