...
class SharedConfigForUpdateDomainVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SharedConfigForUpdateDomainVersionInput';
