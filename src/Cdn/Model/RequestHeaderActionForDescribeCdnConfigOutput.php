...
class RequestHeaderActionForDescribeCdnConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestHeaderActionForDescribeCdnConfigOutput';
