...
class NegativeCacheRuleForUpdateCdnConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NegativeCacheRuleForUpdateCdnConfigInput';
