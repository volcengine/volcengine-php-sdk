...
class TopDataDetailForDescribeEdgeStatusCodeRankingOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TopDataDetailForDescribeEdgeStatusCodeRankingOutput';
