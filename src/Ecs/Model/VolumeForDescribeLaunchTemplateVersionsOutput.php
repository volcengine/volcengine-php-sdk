...
class VolumeForDescribeLaunchTemplateVersionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VolumeForDescribeLaunchTemplateVersionsOutput';
