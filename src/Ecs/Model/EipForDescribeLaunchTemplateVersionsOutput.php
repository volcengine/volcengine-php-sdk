...
class EipForDescribeLaunchTemplateVersionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipForDescribeLaunchTemplateVersionsOutput';
