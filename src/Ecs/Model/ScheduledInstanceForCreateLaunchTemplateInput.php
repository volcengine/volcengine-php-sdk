...
class ScheduledInstanceForCreateLaunchTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScheduledInstanceForCreateLaunchTemplateInput';
