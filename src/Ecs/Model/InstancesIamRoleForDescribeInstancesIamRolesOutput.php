...
class InstancesIamRoleForDescribeInstancesIamRolesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstancesIamRoleForDescribeInstancesIamRolesOutput';
