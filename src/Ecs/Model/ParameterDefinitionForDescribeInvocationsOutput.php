...
class ParameterDefinitionForDescribeInvocationsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParameterDefinitionForDescribeInvocationsOutput';
