...
class ModifyDedicatedHostClusterAttributeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyDedicatedHostClusterAttributeRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dedicated_host_cluster_id'] === null) {
            $invalidProperties[] = "'dedicated_host_cluster_id' can't be null";
        }
