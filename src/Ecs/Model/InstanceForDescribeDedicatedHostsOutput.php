...
class InstanceForDescribeDedicatedHostsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstanceForDescribeDedicatedHostsOutput';
