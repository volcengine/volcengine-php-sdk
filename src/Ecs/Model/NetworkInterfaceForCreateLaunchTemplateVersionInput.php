...
class NetworkInterfaceForCreateLaunchTemplateVersionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkInterfaceForCreateLaunchTemplateVersionInput';
