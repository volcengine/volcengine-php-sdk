...
class CapacityForDescribeDeploymentSetsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CapacityForDescribeDeploymentSetsOutput';
