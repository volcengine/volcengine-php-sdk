...
class MetadataOptionsForDescribeInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MetadataOptionsForDescribeInstancesOutput';
