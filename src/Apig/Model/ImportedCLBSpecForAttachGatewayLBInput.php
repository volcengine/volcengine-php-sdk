...
class ImportedCLBSpecForAttachGatewayLBInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ImportedCLBSpecForAttachGatewayLBInput';
