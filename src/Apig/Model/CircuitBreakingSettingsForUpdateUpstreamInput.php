...
class CircuitBreakingSettingsForUpdateUpstreamInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CircuitBreakingSettingsForUpdateUpstreamInput';
