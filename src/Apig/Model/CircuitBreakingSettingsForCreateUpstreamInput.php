...
class CircuitBreakingSettingsForCreateUpstreamInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CircuitBreakingSettingsForCreateUpstreamInput';
