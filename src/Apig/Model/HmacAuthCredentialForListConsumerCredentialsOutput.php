...
class HmacAuthCredentialForListConsumerCredentialsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HmacAuthCredentialForListConsumerCredentialsOutput';
