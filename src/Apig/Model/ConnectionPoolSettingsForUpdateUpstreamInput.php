...
class ConnectionPoolSettingsForUpdateUpstreamInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConnectionPoolSettingsForUpdateUpstreamInput';
