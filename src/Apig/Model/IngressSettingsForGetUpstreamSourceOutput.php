...
class IngressSettingsForGetUpstreamSourceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IngressSettingsForGetUpstreamSourceOutput';
