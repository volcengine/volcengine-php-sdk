...
class HmacAuthCredentialForCreateConsumerCredentialInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HmacAuthCredentialForCreateConsumerCredentialInput';
