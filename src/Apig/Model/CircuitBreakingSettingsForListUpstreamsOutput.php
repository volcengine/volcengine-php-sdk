...
class CircuitBreakingSettingsForListUpstreamsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CircuitBreakingSettingsForListUpstreamsOutput';
