...
class ConnectionPoolSettingsForGetUpstreamOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConnectionPoolSettingsForGetUpstreamOutput';
