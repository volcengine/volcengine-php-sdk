...
class IngressSettingsForListUpstreamSourcesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IngressSettingsForListUpstreamSourcesOutput';
