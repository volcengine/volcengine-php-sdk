...
class ServiceNetworkSpecForUpdateGatewayServiceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServiceNetworkSpecForUpdateGatewayServiceInput';
