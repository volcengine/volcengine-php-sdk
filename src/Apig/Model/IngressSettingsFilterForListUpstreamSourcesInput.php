...
class IngressSettingsFilterForListUpstreamSourcesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IngressSettingsFilterForListUpstreamSourcesInput';
