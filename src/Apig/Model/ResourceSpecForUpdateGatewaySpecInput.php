...
class ResourceSpecForUpdateGatewaySpecInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceSpecForUpdateGatewaySpecInput';
