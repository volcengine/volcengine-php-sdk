...
class UpdateSecretRotationPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateSecretRotationPolicyRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['automatic_rotation'] === null) {
            $invalidProperties[] = "'automatic_rotation' can't be null";
        }
