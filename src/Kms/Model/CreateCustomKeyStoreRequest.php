...
class CreateCustomKeyStoreRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateCustomKeyStoreRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['custom_key_store_name'] === null) {
            $invalidProperties[] = "'custom_key_store_name' can't be null";
        }
        if ($this->container['custom_key_store_type'] === null) {
            $invalidProperties[] = "'custom_key_store_type' can't be null";
        }
        ...
        if ($this->container['trust_anchor_certificate'] === null) {
            $invalidProperties[] = "'trust_anchor_certificate' can't be null";
        }
    ...
    {
        $allowedValues = $this->getCustomKeyStoreTypeAllowableValues();
        if (!in_array($custom_key_store_type, $allowedValues, true)) {
