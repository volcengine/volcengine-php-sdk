...
class PortalLoginSettingForListPortalLoginSettingsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PortalLoginSettingForListPortalLoginSettingsOutput';
