...
class AttachPolicyToUserProvisionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AttachPolicyToUserProvisionRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_provisioning_id'] === null) {
            $invalidProperties[] = "'user_provisioning_id' can't be null";
        }
