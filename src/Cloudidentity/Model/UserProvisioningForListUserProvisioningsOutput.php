...
class UserProvisioningForListUserProvisioningsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserProvisioningForListUserProvisioningsOutput';
    ...
    {
        $allowedValues = $this->getDeletionStrategyAllowableValues();
        if (!is_null($deletion_strategy) && !in_array($deletion_strategy, $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getDuplicationStrategyAllowableValues();
        if (!is_null($duplication_strategy) && !in_array($duplication_strategy, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'duplication_strategy', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getIdentitySourceStrategyAllowableValues();
        if (!is_null($identity_source_strategy) && !in_array($identity_source_strategy, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'identity_source_strategy', must be one of '%s'",
                    implode("', '", $allowedValues)
