...
class ResourceTagForDTSOpenListTagResourceGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceTagForDTSOpenListTagResourceGroupsOutput';
