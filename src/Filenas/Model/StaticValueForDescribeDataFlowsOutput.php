...
class StaticValueForDescribeDataFlowsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StaticValueForDescribeDataFlowsOutput';
