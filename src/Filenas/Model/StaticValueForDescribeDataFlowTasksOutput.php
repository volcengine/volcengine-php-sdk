...
class StaticValueForDescribeDataFlowTasksOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StaticValueForDescribeDataFlowTasksOutput';
