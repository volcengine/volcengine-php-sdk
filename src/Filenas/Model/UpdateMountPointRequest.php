...
class UpdateMountPointRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateMountPointRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mount_point_id'] === null) {
            $invalidProperties[] = "'mount_point_id' can't be null";
        }
