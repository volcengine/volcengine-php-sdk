...
class SecondaryIndexForModifyGraphSchemaInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecondaryIndexForModifyGraphSchemaInput';
