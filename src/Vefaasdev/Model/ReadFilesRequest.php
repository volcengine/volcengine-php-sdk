...
class ReadFilesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReadFilesRequest';
    ...
    {
        return $this->container['files_path'];
    }

    /**
     * Sets files_path
     *
     * @param string[] $files_path files_path
     *
     * @return $this
     */
    public function setFilesPath($files_path)
    {
        $this->container['files_path'] = $files_path;
