...
class AvailabilityZoneForListInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvailabilityZoneForListInstanceOutput';
