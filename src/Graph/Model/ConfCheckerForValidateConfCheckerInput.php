...
class ConfCheckerForValidateConfCheckerInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfCheckerForValidateConfCheckerInput';
