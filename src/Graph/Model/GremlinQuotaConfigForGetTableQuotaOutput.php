...
class GremlinQuotaConfigForGetTableQuotaOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'gremlin_quota_configForGetTableQuotaOutput';
