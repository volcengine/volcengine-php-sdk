...
class AvailabilityZoneForCreateInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvailabilityZoneForCreateInstanceInput';
