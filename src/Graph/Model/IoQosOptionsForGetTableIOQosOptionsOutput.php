...
class IoQosOptionsForGetTableIOQosOptionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ioQosOptionsForGetTableIOQosOptionsOutput';
