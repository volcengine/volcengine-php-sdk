...
class ConfCheckerForUpdateConfCheckerInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfCheckerForUpdateConfCheckerInput';
