...
class PsmQuotaConfigForGetTableQuotaOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'psm_quota_configForGetTableQuotaOutput';
