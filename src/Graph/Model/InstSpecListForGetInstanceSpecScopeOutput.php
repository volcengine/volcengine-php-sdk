...
class InstSpecListForGetInstanceSpecScopeOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstSpecListForGetInstanceSpecScopeOutput';
