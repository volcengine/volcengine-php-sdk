...
class DecodeRawKeyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DecodeRawKeyRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['raw_key'] === null) {
            $invalidProperties[] = "'raw_key' can't be null";
        }
