...
class LevelForGetAlertingRuleTemplateOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LevelForGetAlertingRuleTemplateOutput';
