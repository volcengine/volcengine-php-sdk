...
class CalChargeItemListForGetWorkspaceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CalChargeItemListForGetWorkspaceOutput';
