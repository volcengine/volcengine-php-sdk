...
class LevelForUpdateAlertingRuleTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LevelForUpdateAlertingRuleTemplateInput';
