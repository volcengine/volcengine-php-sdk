...
class VariableForListAlertingRuleTemplatesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VariableForListAlertingRuleTemplatesOutput';
