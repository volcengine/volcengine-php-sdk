...
class LevelForCreateAlertingRuleTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LevelForCreateAlertingRuleTemplateInput';
