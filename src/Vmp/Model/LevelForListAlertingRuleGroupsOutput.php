...
class LevelForListAlertingRuleGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LevelForListAlertingRuleGroupsOutput';
