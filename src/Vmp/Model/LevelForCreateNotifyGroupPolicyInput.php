...
class LevelForCreateNotifyGroupPolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LevelForCreateNotifyGroupPolicyInput';
