...
class LevelForListAlertingRuleTemplatesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LevelForListAlertingRuleTemplatesOutput';
