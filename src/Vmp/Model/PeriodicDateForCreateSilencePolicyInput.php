...
class PeriodicDateForCreateSilencePolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PeriodicDateForCreateSilencePolicyInput';
