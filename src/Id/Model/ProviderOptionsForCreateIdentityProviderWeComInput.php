...
class ProviderOptionsForCreateIdentityProviderWeComInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProviderOptionsForCreateIdentityProviderWeComInput';
