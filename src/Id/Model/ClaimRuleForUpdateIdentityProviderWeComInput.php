...
class ClaimRuleForUpdateIdentityProviderWeComInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForUpdateIdentityProviderWeComInput';
