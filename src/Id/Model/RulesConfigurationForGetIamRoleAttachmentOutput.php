...
class RulesConfigurationForGetIamRoleAttachmentOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RulesConfigurationForGetIamRoleAttachmentOutput';
