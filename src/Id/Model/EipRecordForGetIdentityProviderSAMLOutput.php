...
class EipRecordForGetIdentityProviderSAMLOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForGetIdentityProviderSAMLOutput';
