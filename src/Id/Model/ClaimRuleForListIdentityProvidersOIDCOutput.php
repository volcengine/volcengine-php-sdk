...
class ClaimRuleForListIdentityProvidersOIDCOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForListIdentityProvidersOIDCOutput';
