...
class ClaimRuleForGetIdentityProviderOAuthOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForGetIdentityProviderOAuthOutput';
