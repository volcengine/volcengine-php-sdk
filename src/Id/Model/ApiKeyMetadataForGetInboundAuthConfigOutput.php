...
class ApiKeyMetadataForGetInboundAuthConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiKeyMetadataForGetInboundAuthConfigOutput';
