...
class ClaimRuleForListIdentityProvidersOAuthOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForListIdentityProvidersOAuthOutput';
