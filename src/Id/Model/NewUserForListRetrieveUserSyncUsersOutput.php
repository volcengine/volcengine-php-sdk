...
class NewUserForListRetrieveUserSyncUsersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewUserForListRetrieveUserSyncUsersOutput';
