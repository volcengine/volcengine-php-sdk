...
class BackendForCreateServiceFromTemplateOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BackendForCreateServiceFromTemplateOutput';
