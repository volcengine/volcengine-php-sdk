...
class GetIdentityProviderLDAPADAgentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetIdentityProviderLDAPADAgentRequest';
