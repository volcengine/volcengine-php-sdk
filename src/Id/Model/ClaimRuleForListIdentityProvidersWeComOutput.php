...
class ClaimRuleForListIdentityProvidersWeComOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForListIdentityProvidersWeComOutput';
