...
class ApiKeyMetadataForUpdateInboundAuthConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiKeyMetadataForUpdateInboundAuthConfigInput';
