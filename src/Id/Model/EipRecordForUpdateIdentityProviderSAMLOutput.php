...
class EipRecordForUpdateIdentityProviderSAMLOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForUpdateIdentityProviderSAMLOutput';
