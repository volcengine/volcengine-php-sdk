...
class GetTaskStateRetrieveAppVisibleUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetTaskStateRetrieveAppVisibleUsersRequest';
