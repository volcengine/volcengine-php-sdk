...
class ClaimRuleForListIdentityProvidersSAMLOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForListIdentityProvidersSAMLOutput';
