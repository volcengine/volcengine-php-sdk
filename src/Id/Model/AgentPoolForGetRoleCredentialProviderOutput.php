...
class AgentPoolForGetRoleCredentialProviderOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AgentPoolForGetRoleCredentialProviderOutput';
