...
class ClaimRuleForUpdateIdentityProviderSAMLOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForUpdateIdentityProviderSAMLOutput';
