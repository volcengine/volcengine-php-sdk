...
class DepartmentForUploadDepartmentSyncDepartmentsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DepartmentForUploadDepartmentSyncDepartmentsInput';
