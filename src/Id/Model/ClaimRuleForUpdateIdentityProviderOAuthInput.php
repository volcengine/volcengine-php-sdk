...
class ClaimRuleForUpdateIdentityProviderOAuthInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForUpdateIdentityProviderOAuthInput';
