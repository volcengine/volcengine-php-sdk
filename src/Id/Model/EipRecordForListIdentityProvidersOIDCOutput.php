...
class EipRecordForListIdentityProvidersOIDCOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForListIdentityProvidersOIDCOutput';
