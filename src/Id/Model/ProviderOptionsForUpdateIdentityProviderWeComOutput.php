...
class ProviderOptionsForUpdateIdentityProviderWeComOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProviderOptionsForUpdateIdentityProviderWeComOutput';
