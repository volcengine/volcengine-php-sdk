...
class UserPoolForListRoleCredentialProvidersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserPoolForListRoleCredentialProvidersOutput';
