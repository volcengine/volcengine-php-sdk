...
class BatchConvertFederatedUsersToNativeUsersRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchConvertFederatedUsersToNativeUsersRequest';
