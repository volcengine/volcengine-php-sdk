...
class ProviderOptionsForGetIdentityProviderWeComOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProviderOptionsForGetIdentityProviderWeComOutput';
