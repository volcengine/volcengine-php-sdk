...
class ClaimRuleForUpdateIdentityProviderWeComOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForUpdateIdentityProviderWeComOutput';
