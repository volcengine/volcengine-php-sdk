...
class SuccessfulUidsStructuredForCreateUsersCSVOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SuccessfulUidsStructuredForCreateUsersCSVOutput';
