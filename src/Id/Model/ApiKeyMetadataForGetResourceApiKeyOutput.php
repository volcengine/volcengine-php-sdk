...
class ApiKeyMetadataForGetResourceApiKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiKeyMetadataForGetResourceApiKeyOutput';
