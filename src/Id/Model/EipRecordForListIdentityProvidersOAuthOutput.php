...
class EipRecordForListIdentityProvidersOAuthOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForListIdentityProvidersOAuthOutput';
