...
class ExternalIdentityForListUsersInDepartmentOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExternalIdentityForListUsersInDepartmentOutput';
