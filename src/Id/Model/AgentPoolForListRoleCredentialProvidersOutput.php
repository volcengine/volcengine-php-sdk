...
class AgentPoolForListRoleCredentialProvidersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AgentPoolForListRoleCredentialProvidersOutput';
