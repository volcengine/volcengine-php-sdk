...
class RulesConfigurationForUpdateIamRoleAttachmentOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RulesConfigurationForUpdateIamRoleAttachmentOutput';
