...
class DeleteIdentityProviderLDAPADAgentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteIdentityProviderLDAPADAgentRequest';
