...
class CustomAttributeForUpdateUserPoolOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomAttributeForUpdateUserPoolOutput';
