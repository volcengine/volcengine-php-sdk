...
class ClaimRuleForGetIdentityProviderTokenExchangeOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForGetIdentityProviderTokenExchangeOutput';
