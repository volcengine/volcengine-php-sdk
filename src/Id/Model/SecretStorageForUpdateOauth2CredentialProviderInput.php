...
class SecretStorageForUpdateOauth2CredentialProviderInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecretStorageForUpdateOauth2CredentialProviderInput';
