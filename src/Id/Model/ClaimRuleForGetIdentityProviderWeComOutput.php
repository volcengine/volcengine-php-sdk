...
class ClaimRuleForGetIdentityProviderWeComOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForGetIdentityProviderWeComOutput';
