...
class EipRecordForListIdentityProvidersWeComOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForListIdentityProvidersWeComOutput';
