...
class SecretStorageForCreateOauth2CredentialProviderInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecretStorageForCreateOauth2CredentialProviderInput';
