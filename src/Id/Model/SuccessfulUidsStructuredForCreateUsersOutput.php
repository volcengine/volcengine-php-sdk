...
class SuccessfulUidsStructuredForCreateUsersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SuccessfulUidsStructuredForCreateUsersOutput';
