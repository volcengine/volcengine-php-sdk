...
class ApiKeyMetadataForBatchGetInboundAuthConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiKeyMetadataForBatchGetInboundAuthConfigOutput';
