...
class ErrorsStructuredForUpdateUsersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ErrorsStructuredForUpdateUsersOutput';
