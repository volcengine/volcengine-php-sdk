...
class ClaimRuleForCreateIdentityProviderWeComInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForCreateIdentityProviderWeComInput';
