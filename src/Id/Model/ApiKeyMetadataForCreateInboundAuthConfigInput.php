...
class ApiKeyMetadataForCreateInboundAuthConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiKeyMetadataForCreateInboundAuthConfigInput';
