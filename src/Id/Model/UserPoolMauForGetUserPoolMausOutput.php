...
class UserPoolMauForGetUserPoolMausOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserPoolMauForGetUserPoolMausOutput';
    ...
    {
        $this->container['mau'] = isset($data['mau']) ? $data['mau'] : null;
