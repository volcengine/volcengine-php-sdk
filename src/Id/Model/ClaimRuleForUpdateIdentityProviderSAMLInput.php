...
class ClaimRuleForUpdateIdentityProviderSAMLInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForUpdateIdentityProviderSAMLInput';
