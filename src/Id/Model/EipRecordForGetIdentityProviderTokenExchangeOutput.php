...
class EipRecordForGetIdentityProviderTokenExchangeOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForGetIdentityProviderTokenExchangeOutput';
