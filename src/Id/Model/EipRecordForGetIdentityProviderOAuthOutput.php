...
class EipRecordForGetIdentityProviderOAuthOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForGetIdentityProviderOAuthOutput';
