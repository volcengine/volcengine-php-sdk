...
class ListIdentityProvidersTokenExchangeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListIdentityProvidersTokenExchangeRequest';
