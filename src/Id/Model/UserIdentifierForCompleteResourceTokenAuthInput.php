...
class UserIdentifierForCompleteResourceTokenAuthInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserIdentifierForCompleteResourceTokenAuthInput';
