...
class EipRecordForUpdateIdentityProviderOIDCOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForUpdateIdentityProviderOIDCOutput';
