...
class SecretStorageForCreateApiKeyCredentialProviderInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SecretStorageForCreateApiKeyCredentialProviderInput';
