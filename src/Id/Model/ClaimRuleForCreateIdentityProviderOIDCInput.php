...
class ClaimRuleForCreateIdentityProviderOIDCInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForCreateIdentityProviderOIDCInput';
