...
class EipRecordForCreateIdentityProviderSAMLOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForCreateIdentityProviderSAMLOutput';
