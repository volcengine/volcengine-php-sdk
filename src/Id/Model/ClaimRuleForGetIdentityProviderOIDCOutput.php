...
class ClaimRuleForGetIdentityProviderOIDCOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClaimRuleForGetIdentityProviderOIDCOutput';
