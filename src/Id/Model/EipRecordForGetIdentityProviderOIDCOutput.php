...
class EipRecordForGetIdentityProviderOIDCOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForGetIdentityProviderOIDCOutput';
