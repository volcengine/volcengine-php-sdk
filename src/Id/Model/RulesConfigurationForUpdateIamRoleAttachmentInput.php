...
class RulesConfigurationForUpdateIamRoleAttachmentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RulesConfigurationForUpdateIamRoleAttachmentInput';
