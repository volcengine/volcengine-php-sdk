...
class ProviderOptionsForCreateIdentityProviderWeComOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProviderOptionsForCreateIdentityProviderWeComOutput';
