...
class ApiKeyMetadataForCreateInboundAuthConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApiKeyMetadataForCreateInboundAuthConfigOutput';
