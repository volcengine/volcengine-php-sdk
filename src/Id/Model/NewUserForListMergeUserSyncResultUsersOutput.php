...
class NewUserForListMergeUserSyncResultUsersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewUserForListMergeUserSyncResultUsersOutput';
