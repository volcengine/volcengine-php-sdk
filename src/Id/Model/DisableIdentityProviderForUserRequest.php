...
class DisableIdentityProviderForUserRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DisableIdentityProviderForUserRequest';
    ...
    protected static $swaggerFormats = [
        'connection_uid' => null,
        'external_provider_user_id' => null,
        'user_pool_uid' => null,
    ...
    protected static $setters = [
        ...
        'external_provider_user_id' => 'setExternalProviderUserId',
    ...
    protected static $getters = [
        ...
        'external_provider_user_id' => 'getExternalProviderUserId',
    ...
    public function __construct($data = null)
    {
        ...
        $this->container['external_provider_user_id'] = isset($data['external_provider_user_id']) ? $data['external_provider_user_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_provider_user_id'] === null) {
            $invalidProperties[] = "'external_provider_user_id' can't be null";
        }
        if ($this->container['user_pool_uid'] === null) {
            $invalidProperties[] = "'user_pool_uid' can't be null";
        }
        if ($this->container['user_pool_user_uid'] === null) {
            $invalidProperties[] = "'user_pool_user_uid' can't be null";
        }
    ...
    /**
     * Gets external_provider_user_id
     *
     * @return string
     */
    public function getExternalProviderUserId()
    {
        return $this->container['external_provider_user_id'];
    }

    /**
     * Sets external_provider_user_id
     *
     * @param string $external_provider_user_id external_provider_user_id
     *
     * @return $this
     */
    public function setExternalProviderUserId($external_provider_user_id)
    {
        $this->container['external_provider_user_id'] = $external_provider_user_id;
