...
class EipRecordForCreateIdentityProviderOIDCOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForCreateIdentityProviderOIDCOutput';
