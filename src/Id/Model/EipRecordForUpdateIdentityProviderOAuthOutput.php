...
class EipRecordForUpdateIdentityProviderOAuthOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipRecordForUpdateIdentityProviderOAuthOutput';
