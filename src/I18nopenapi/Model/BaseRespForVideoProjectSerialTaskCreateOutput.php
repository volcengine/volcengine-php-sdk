...
class BaseRespForVideoProjectSerialTaskCreateOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BaseRespForVideoProjectSerialTaskCreateOutput';
