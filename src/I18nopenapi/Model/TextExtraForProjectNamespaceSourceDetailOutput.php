...
class TextExtraForProjectNamespaceSourceDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'textExtraForProjectNamespaceSourceDetailOutput';
