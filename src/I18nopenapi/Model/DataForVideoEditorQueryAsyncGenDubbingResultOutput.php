...
class DataForVideoEditorQueryAsyncGenDubbingResultOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'dataForVideoEditorQueryAsyncGenDubbingResultOutput';
