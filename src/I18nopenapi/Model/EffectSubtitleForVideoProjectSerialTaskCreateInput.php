...
class EffectSubtitleForVideoProjectSerialTaskCreateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'effectSubtitleForVideoProjectSerialTaskCreateInput';
