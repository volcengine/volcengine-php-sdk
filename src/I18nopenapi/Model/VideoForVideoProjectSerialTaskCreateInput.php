...
class VideoForVideoProjectSerialTaskCreateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'videoForVideoProjectSerialTaskCreateInput';
