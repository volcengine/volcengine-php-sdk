...
class DataForVideoProjectGetUploadSubtitleStatusOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'dataForVideoProjectGetUploadSubtitleStatusOutput';
