...
class SubTaskSpeakerForVideoEditorGetSpeakersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'subTaskSpeakerForVideoEditorGetSpeakersOutput';
