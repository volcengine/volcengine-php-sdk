...
class BaseRespForVideoEditorAsyncGenDubbingOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'baseRespForVideoEditorAsyncGenDubbingOutput';
