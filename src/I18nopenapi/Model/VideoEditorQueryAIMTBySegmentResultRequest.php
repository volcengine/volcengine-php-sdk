...
class VideoEditorQueryAIMTBySegmentResultRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VideoEditorQueryAIMTBySegmentResultRequest';
