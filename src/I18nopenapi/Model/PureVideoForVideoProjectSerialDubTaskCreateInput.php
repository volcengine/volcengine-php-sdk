...
class PureVideoForVideoProjectSerialDubTaskCreateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'pureVideoForVideoProjectSerialDubTaskCreateInput';
