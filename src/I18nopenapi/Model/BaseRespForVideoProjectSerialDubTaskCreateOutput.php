...
class BaseRespForVideoProjectSerialDubTaskCreateOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BaseRespForVideoProjectSerialDubTaskCreateOutput';
