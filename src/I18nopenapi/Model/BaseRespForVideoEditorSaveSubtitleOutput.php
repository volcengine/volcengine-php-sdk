...
class BaseRespForVideoEditorSaveSubtitleOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'baseRespForVideoEditorSaveSubtitleOutput';
