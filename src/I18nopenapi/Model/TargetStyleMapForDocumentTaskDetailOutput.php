...
class TargetStyleMapForDocumentTaskDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'targetStyleMapForDocumentTaskDetailOutput';
