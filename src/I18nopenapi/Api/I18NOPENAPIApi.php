...
class I18NOPENAPIApi
{
    ...
    {
        $resourcePath = '/VideoProjectSubmitTermValidation/2021-05-21/i18n_openapi/post/application_json/';
        $queryParams = [];
        $httpBody = $body;
    ...
    public function videoProjectTaskBatchSetExpedited($body = null)
    {
        list($response) = $this->videoProjectTaskBatchSetExpeditedWithHttpInfo($body);
        return $response;
    }

    public function videoProjectTaskBatchSetExpeditedWithHttpInfo($body)
    {
        $returnType = '\Volcengine\I18nopenapi\Model\VideoProjectTaskBatchSetExpeditedResponse';
        $request = $this->videoProjectTaskBatchSetExpeditedRequest($body);

        return $this->apiClient->callApi($body, $request['resourcePath'], $request['method'], $request['headers'], $returnType);
    }

    public function videoProjectTaskBatchSetExpeditedAsync($body = null)
    {
        return $this->videoProjectTaskBatchSetExpeditedAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function videoProjectTaskBatchSetExpeditedAsyncWithHttpInfo($body)
    {
        $returnType = '\Volcengine\I18nopenapi\Model\VideoProjectTaskBatchSetExpeditedResponse';
        $request = $this->videoProjectTaskBatchSetExpeditedRequest($body);
        return $this->apiClient->callApi($body, $request['resourcePath'], $request['method'], $request['headers'], $returnType, true);
    ...
    protected function videoProjectTaskBatchSetExpeditedRequest($body)
    {
        $resourcePath = '/VideoProjectTaskBatchSetExpedited/2021-05-21/i18n_openapi/post/application_json/';
        $queryParams = [];
        $httpBody = $body;
