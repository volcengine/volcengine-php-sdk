...
class PolicyForListProjectIdentitiesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyForListProjectIdentitiesOutput';
