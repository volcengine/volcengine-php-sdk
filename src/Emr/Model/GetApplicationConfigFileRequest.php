...
class GetApplicationConfigFileRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetApplicationConfigFileRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['config_file_name'] === null) {
            $invalidProperties[] = "'config_file_name' can't be null";
        }
