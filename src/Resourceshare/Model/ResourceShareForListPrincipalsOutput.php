...
class ResourceShareForListPrincipalsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceShareForListPrincipalsOutput';
