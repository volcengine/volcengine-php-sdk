...
class ListResourceAssociationAuthorizationsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListResourceAssociationAuthorizationsRequest';
