...
class IpConfigForCreateResolverEndpointInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpConfigForCreateResolverEndpointInput';
