...
class IpConfigForQueryResolverEndpointOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpConfigForQueryResolverEndpointOutput';
