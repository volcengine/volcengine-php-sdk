...
class AlgorithmBaseRespForLensVidaVideoGetResultOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'algorithm_base_respForLensVidaVideoGetResultOutput';
