...
class HighAesIPV20Request implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HighAesIPV20Request';
    ...
    protected static $swaggerTypes = [
        ...
        'height' => 'int',
        'image_urls' => 'string[]',
        'logo_info' => '\Volcengine\Cv20240606\Model\LogoInfoForHighAesIPV20Input',
        'prompt' => 'string',
        'ref_id_weight' => 'float',
        'ref_ip_weight' => 'float',
        'req_key' => 'string',
     ...
     * @return float
     */
    public function getCfgRescale()
    {
        return $this->container['cfg_rescale'];
    }

    /**
     * Sets cfg_rescale
     *
     * @param float $cfg_rescale cfg_rescale
     *
     * @return $this
     */
    public function setCfgRescale($cfg_rescale)
    {
        $this->container['cfg_rescale'] = $cfg_rescale;
     ...
     * Gets logo_info
     *
     * @return \Volcengine\Cv20240606\Model\LogoInfoForHighAesIPV20Input
     */
     ...
     * Sets logo_info
     *
     * @param \Volcengine\Cv20240606\Model\LogoInfoForHighAesIPV20Input $logo_info logo_info
     *
     * @return $this
     */
