...
class AlgorithmBaseRespForImg2ImgOutpaintingOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'algorithm_base_respForImg2ImgOutpaintingOutput';
