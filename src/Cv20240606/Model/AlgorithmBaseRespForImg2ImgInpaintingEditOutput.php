...
class AlgorithmBaseRespForImg2ImgInpaintingEditOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'algorithm_base_respForImg2ImgInpaintingEditOutput';
