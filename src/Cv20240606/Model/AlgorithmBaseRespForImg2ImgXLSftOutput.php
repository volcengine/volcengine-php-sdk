...
class AlgorithmBaseRespForImg2ImgXLSftOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'algorithm_base_respForImg2ImgXLSftOutput';
