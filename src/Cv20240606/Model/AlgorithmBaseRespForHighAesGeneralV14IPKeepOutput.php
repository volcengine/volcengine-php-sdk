...
class AlgorithmBaseRespForHighAesGeneralV14IPKeepOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'algorithm_base_respForHighAesGeneralV14IPKeepOutput';
