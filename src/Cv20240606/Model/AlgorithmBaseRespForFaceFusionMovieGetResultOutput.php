...
class AlgorithmBaseRespForFaceFusionMovieGetResultOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'algorithm_base_respForFaceFusionMovieGetResultOutput';
