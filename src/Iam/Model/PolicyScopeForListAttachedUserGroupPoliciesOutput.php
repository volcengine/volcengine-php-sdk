...
class PolicyScopeForListAttachedUserGroupPoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyScopeForListAttachedUserGroupPoliciesOutput';
