...
class LoginProfileForUpdateLoginProfileOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LoginProfileForUpdateLoginProfileOutput';
