...
class OIDCProviderForListOIDCProvidersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OIDCProviderForListOIDCProvidersOutput';
