...
class PolicyRoleForListEntitiesForPolicyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyRoleForListEntitiesForPolicyOutput';
