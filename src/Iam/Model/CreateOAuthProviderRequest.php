...
class CreateOAuthProviderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateOAuthProviderRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authorize_template'] === null) {
            $invalidProperties[] = "'authorize_template' can't be null";
        }
        ...
        if ($this->container['identity_map_type'] === null) {
            $invalidProperties[] = "'identity_map_type' can't be null";
        }
        if ($this->container['idp_identity_key'] === null) {
            $invalidProperties[] = "'idp_identity_key' can't be null";
        }
        ...
        if ($this->container['user_info_url'] === null) {
            $invalidProperties[] = "'user_info_url' can't be null";
        }
