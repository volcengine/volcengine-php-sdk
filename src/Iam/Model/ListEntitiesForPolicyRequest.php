...
class ListEntitiesForPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListEntitiesForPolicyRequest';
    ...
    {
        $this->container['entity_filter'] = isset($data['entity_filter']) ? $data['entity_filter'] : null;
    ...
    {
        return $this->container['entity_filter'];
    }

    /**
     * Sets entity_filter
     *
     * @param string $entity_filter entity_filter
     *
     * @return $this
     */
    public function setEntityFilter($entity_filter)
    {
        $this->container['entity_filter'] = $entity_filter;
