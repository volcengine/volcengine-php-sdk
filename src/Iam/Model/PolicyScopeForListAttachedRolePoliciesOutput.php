...
class PolicyScopeForListAttachedRolePoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyScopeForListAttachedRolePoliciesOutput';
