...
class SetSecurityConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SetSecurityConfigRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['safe_auth_type'] === null) {
            $invalidProperties[] = "'safe_auth_type' can't be null";
        }
