...
class RemoveSAMLProviderCertificateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemoveSAMLProviderCertificateRequest';
