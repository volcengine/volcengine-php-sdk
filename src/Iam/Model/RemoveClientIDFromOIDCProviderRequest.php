...
class RemoveClientIDFromOIDCProviderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemoveClientIDFromOIDCProviderRequest';
