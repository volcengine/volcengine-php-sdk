...
class PolicyScopeForListAttachedUserPoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyScopeForListAttachedUserPoliciesOutput';
