...
class AccessKeyMetadataForListAccessKeysOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccessKeyMetadataForListAccessKeysOutput';
