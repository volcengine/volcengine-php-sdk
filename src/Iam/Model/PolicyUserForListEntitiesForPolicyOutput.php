...
class PolicyUserForListEntitiesForPolicyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyUserForListEntitiesForPolicyOutput';
