...
class ListAttachedUserGroupPoliciesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListAttachedUserGroupPoliciesRequest';
