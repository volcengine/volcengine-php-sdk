...
class CreateSAMLProviderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateSAMLProviderRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['encoded_saml_metadata_document'] === null) {
            $invalidProperties[] = "'encoded_saml_metadata_document' can't be null";
        }
        if ($this->container['saml_provider_name'] === null) {
            $invalidProperties[] = "'saml_provider_name' can't be null";
        }
        if ($this->container['sso_type'] === null) {
            $invalidProperties[] = "'sso_type' can't be null";
        }
