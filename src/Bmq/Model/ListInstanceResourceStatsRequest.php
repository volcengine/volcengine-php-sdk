...
class ListInstanceResourceStatsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListInstanceResourceStatsRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instance_ids'] === null) {
            $invalidProperties[] = "'instance_ids' can't be null";
        }
