...
class EvictionHardForCreateDefaultNodePoolInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EvictionHardForCreateDefaultNodePoolInput';
