...
class ConditionForListNodesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionForListNodesOutput';
    ...
    const TYPE_OK = 'Ok';
    const TYPE_UNSCHEDULABLE = 'Unschedulable';
    const TYPE_NOT_READY = 'NotReady';
    const TYPE_INITIALIZE_FAILED = 'InitializeFailed';
    ...
    public function getTypeAllowableValues()
    {
        return [
            self::TYPE_OK,
            self::TYPE_UNSCHEDULABLE,
            self::TYPE_NOT_READY,
            self::TYPE_INITIALIZE_FAILED,
