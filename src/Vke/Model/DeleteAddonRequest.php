...
class DeleteAddonRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteAddonRequest';
    ...
    const CASCADING_DELETE_RESOURCES_CRD = 'Crd';
    const RETAIN_RESOURCES_CRD = 'Crd';
    ...
    {
        return [
            self::CASCADING_DELETE_RESOURCES_CRD,
        ];
    }
