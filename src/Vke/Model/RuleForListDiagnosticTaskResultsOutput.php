...
class RuleForListDiagnosticTaskResultsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RuleForListDiagnosticTaskResultsOutput';
