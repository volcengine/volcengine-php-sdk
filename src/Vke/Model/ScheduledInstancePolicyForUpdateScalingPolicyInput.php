...
class ScheduledInstancePolicyForUpdateScalingPolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScheduledInstancePolicyForUpdateScalingPolicyInput';
