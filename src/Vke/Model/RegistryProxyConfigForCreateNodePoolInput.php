...
class RegistryProxyConfigForCreateNodePoolInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegistryProxyConfigForCreateNodePoolInput';
