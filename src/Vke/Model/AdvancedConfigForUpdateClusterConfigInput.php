...
class AdvancedConfigForUpdateClusterConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AdvancedConfigForUpdateClusterConfigInput';
