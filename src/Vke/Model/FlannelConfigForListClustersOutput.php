...
class FlannelConfigForListClustersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlannelConfigForListClustersOutput';
    ...
    /**
     * Gets max_pods_per_node
     *
     * @return int
     */
    public function getMaxPodsPerNode()
    {
        return $this->container['max_pods_per_node'];
    }

    /**
     * Sets max_pods_per_node
     *
     * @param int $max_pods_per_node max_pods_per_node
     *
     * @return $this
     */
    public function setMaxPodsPerNode($max_pods_per_node)
    {
        $this->container['max_pods_per_node'] = $max_pods_per_node;
    ...
    {
        return $this->container['pod_cidrs'];
    }

    /**
     * Sets pod_cidrs
     *
     * @param string[] $pod_cidrs pod_cidrs
     *
     * @return $this
     */
