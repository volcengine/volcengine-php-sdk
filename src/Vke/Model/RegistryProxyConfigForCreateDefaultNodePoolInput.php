...
class RegistryProxyConfigForCreateDefaultNodePoolInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegistryProxyConfigForCreateDefaultNodePoolInput';
