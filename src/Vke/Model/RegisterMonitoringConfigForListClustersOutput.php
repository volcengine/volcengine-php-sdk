...
class RegisterMonitoringConfigForListClustersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegisterMonitoringConfigForListClustersOutput';
