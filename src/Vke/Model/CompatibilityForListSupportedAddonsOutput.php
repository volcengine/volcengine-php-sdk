...
class CompatibilityForListSupportedAddonsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompatibilityForListSupportedAddonsOutput';
