...
class VpcCniConfigForUpdateClusterConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VpcCniConfigForUpdateClusterConfigInput';
