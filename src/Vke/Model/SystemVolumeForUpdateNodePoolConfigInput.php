...
class SystemVolumeForUpdateNodePoolConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SystemVolumeForUpdateNodePoolConfigInput';
