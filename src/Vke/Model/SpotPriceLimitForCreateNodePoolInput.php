...
class SpotPriceLimitForCreateNodePoolInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpotPriceLimitForCreateNodePoolInput';
