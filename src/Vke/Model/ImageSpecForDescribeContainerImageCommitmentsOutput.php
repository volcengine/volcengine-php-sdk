...
class ImageSpecForDescribeContainerImageCommitmentsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ImageSpecForDescribeContainerImageCommitmentsOutput';
