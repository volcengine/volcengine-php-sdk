...
class GpuDriverConfigForCreateNodePoolInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GpuDriverConfigForCreateNodePoolInput';
