...
class AutoScalingForUpdateNodePoolConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoScalingForUpdateNodePoolConfigInput';
