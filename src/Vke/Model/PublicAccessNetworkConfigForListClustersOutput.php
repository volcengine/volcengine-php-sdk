...
class PublicAccessNetworkConfigForListClustersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicAccessNetworkConfigForListClustersOutput';
