...
class IntersectionItemForListSupportedImagesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntersectionItemForListSupportedImagesOutput';
