...
class ComponentConfigForUpdateClusterConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ComponentConfigForUpdateClusterConfigInput';
