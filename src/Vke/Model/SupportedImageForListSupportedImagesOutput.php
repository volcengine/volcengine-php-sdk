...
class SupportedImageForListSupportedImagesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SupportedImageForListSupportedImagesOutput';
