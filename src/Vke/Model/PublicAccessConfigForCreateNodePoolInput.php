...
class PublicAccessConfigForCreateNodePoolInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicAccessConfigForCreateNodePoolInput';
