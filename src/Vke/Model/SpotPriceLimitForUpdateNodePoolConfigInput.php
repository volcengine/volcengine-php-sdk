...
class SpotPriceLimitForUpdateNodePoolConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpotPriceLimitForUpdateNodePoolConfigInput';
