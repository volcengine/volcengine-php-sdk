...
class TaskProgressForQueryDataMigrateTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaskProgressForQueryDataMigrateTaskOutput';
