...
class ObjectSourceConfigForQueryDataMigrateTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ObjectSourceConfigForQueryDataMigrateTaskOutput';
