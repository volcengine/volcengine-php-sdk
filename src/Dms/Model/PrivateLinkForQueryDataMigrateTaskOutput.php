...
class PrivateLinkForQueryDataMigrateTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrivateLinkForQueryDataMigrateTaskOutput';
