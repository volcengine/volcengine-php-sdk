...
class ListAccountGroupDeliveryChannelsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListAccountGroupDeliveryChannelsRequest';
