...
class RegionsForUpdateConformancePackInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionsForUpdateConformancePackInput';
