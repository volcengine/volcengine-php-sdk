...
class DisassociateAccountGroupPrincipalsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DisassociateAccountGroupPrincipalsRequest';
