...
class ParameterForUpdateAccountGroupRuleTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParameterForUpdateAccountGroupRuleTemplateInput';
