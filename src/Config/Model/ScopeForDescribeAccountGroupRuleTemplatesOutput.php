...
class ScopeForDescribeAccountGroupRuleTemplatesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScopeForDescribeAccountGroupRuleTemplatesOutput';
