...
class RegionsForUpdateAccountGroupConformancePackInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionsForUpdateAccountGroupConformancePackInput';
