...
class RegionsForCreateAccountGroupConformancePackInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionsForCreateAccountGroupConformancePackInput';
