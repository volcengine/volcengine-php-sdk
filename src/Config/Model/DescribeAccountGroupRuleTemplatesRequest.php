...
class DescribeAccountGroupRuleTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeAccountGroupRuleTemplatesRequest';
