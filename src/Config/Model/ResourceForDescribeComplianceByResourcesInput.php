...
class ResourceForDescribeComplianceByResourcesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceForDescribeComplianceByResourcesInput';
