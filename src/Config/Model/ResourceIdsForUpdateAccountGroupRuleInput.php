...
class ResourceIdsForUpdateAccountGroupRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceIdsForUpdateAccountGroupRuleInput';
