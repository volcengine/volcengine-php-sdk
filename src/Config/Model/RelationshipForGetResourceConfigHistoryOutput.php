...
class RelationshipForGetResourceConfigHistoryOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RelationshipForGetResourceConfigHistoryOutput';
