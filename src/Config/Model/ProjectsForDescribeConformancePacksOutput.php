...
class ProjectsForDescribeConformancePacksOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectsForDescribeConformancePacksOutput';
