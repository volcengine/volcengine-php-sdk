...
class ResourceTypesForUpdateAccountGroupRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceTypesForUpdateAccountGroupRuleInput';
