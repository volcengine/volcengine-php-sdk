...
class GetAccountGroupResourceConfigHistoryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetAccountGroupResourceConfigHistoryRequest';
