...
class ScopeForUpdateAccountGroupRuleTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScopeForUpdateAccountGroupRuleTemplateInput';
