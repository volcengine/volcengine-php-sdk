...
class DisableAccountGroupResourceExemptionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DisableAccountGroupResourceExemptionRequest';
