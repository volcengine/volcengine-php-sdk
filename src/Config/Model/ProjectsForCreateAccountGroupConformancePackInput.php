...
class ProjectsForCreateAccountGroupConformancePackInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectsForCreateAccountGroupConformancePackInput';
