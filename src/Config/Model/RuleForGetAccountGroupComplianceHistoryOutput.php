...
class RuleForGetAccountGroupComplianceHistoryOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RuleForGetAccountGroupComplianceHistoryOutput';
