...
class GetOrganizationDiscoveredResourceCountsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetOrganizationDiscoveredResourceCountsRequest';
