...
class ParameterForCreateAccountGroupRuleTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParameterForCreateAccountGroupRuleTemplateInput';
