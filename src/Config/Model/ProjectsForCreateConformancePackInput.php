...
class ProjectsForCreateConformancePackInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectsForCreateConformancePackInput';
