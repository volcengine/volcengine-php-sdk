...
class RegionsForDescribeConformancePacksOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionsForDescribeConformancePacksOutput';
