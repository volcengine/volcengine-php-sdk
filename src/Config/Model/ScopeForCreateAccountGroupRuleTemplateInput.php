...
class ScopeForCreateAccountGroupRuleTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScopeForCreateAccountGroupRuleTemplateInput';
