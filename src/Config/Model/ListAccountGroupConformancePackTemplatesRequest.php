...
class ListAccountGroupConformancePackTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListAccountGroupConformancePackTemplatesRequest';
