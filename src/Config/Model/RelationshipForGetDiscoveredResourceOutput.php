...
class RelationshipForGetDiscoveredResourceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RelationshipForGetDiscoveredResourceOutput';
