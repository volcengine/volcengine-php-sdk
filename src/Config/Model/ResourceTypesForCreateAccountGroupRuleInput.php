...
class ResourceTypesForCreateAccountGroupRuleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceTypesForCreateAccountGroupRuleInput';
