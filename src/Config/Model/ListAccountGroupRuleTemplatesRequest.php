...
class ListAccountGroupRuleTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListAccountGroupRuleTemplatesRequest';
