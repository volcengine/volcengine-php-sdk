...
class ResourceIdsForUpdateAccountGroupConformancePackInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceIdsForUpdateAccountGroupConformancePackInput';
