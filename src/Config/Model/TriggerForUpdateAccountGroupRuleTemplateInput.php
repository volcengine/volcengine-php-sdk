...
class TriggerForUpdateAccountGroupRuleTemplateInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TriggerForUpdateAccountGroupRuleTemplateInput';
