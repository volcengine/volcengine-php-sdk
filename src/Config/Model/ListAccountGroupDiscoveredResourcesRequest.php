...
class ListAccountGroupDiscoveredResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListAccountGroupDiscoveredResourcesRequest';
