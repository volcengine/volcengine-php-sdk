...
class CreateConformancePackTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateConformancePackTemplateRequest';
