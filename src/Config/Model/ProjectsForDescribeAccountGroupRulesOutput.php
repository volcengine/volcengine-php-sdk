...
class ProjectsForDescribeAccountGroupRulesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectsForDescribeAccountGroupRulesOutput';
