...
class DeleteAccountGroupRuleTemplatesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteAccountGroupRuleTemplatesRequest';
