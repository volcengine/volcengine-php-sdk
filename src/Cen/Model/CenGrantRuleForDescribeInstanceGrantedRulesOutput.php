...
class CenGrantRuleForDescribeInstanceGrantedRulesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CenGrantRuleForDescribeInstanceGrantedRulesOutput';
