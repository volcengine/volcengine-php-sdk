...
class DescribeCenAttachedInstanceAttributesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeCenAttachedInstanceAttributesResponse';
