...
class CreateCenInterRegionBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateCenInterRegionBandwidthRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['local_region_id'] === null) {
            $invalidProperties[] = "'local_region_id' can't be null";
        }
        if ($this->container['peer_region_id'] === null) {
            $invalidProperties[] = "'peer_region_id' can't be null";
        }
