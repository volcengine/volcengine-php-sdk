...
class RevokeInstanceFromCenRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RevokeInstanceFromCenRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cen_owner_id'] === null) {
            $invalidProperties[] = "'cen_owner_id' can't be null";
        }
