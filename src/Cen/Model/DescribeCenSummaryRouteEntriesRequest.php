...
class DescribeCenSummaryRouteEntriesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeCenSummaryRouteEntriesRequest';
