...
class DescribeCenAttachedInstanceAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeCenAttachedInstanceAttributesRequest';
