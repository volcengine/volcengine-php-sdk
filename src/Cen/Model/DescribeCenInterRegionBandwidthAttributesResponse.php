...
class DescribeCenInterRegionBandwidthAttributesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeCenInterRegionBandwidthAttributesResponse';
