...
class PublishToInstanceForCreateCenServiceRouteEntryInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublishToInstanceForCreateCenServiceRouteEntryInput';
