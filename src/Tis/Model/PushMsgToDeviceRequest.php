...
class PushMsgToDeviceRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PushMsgToDeviceRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['msg_content'] === null) {
            $invalidProperties[] = "'msg_content' can't be null";
        }
    ...
    {
        return $this->container['msg_content'];
    }

    /**
     * Sets msg_content
     *
     * @param string $msg_content msg_content
     *
     * @return $this
     */
    public function setMsgContent($msg_content)
    {
        $this->container['msg_content'] = $msg_content;
