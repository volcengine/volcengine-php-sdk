...
class CategoryForGetSpeakerListOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CategoryForGetSpeakerListOutput';
