...
class CreateDirectConnectTrafficQosQueueResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateDirectConnectTrafficQosQueueResponse';
