...
class DeleteDirectConnectVirtualInterfaceRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteDirectConnectVirtualInterfaceRequest';
