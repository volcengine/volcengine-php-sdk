...
class CreateDirectConnectGatewayRouteResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateDirectConnectGatewayRouteResponse';
