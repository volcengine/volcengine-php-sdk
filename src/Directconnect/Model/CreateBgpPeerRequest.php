...
class CreateBgpPeerRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateBgpPeerRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['remote_asn'] === null) {
            $invalidProperties[] = "'remote_asn' can't be null";
        }
