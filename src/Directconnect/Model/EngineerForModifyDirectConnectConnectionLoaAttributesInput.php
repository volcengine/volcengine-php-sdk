...
class EngineerForModifyDirectConnectConnectionLoaAttributesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EngineerForModifyDirectConnectConnectionLoaAttributesInput';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['certificate_no'] === null) {
            $invalidProperties[] = "'certificate_no' can't be null";
        }
