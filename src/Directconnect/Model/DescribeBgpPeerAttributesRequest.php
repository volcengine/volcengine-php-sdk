...
class DescribeBgpPeerAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeBgpPeerAttributesRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bgp_peer_id'] === null) {
            $invalidProperties[] = "'bgp_peer_id' can't be null";
        }
