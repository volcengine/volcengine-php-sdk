...
class DeleteDirectConnectConnectionRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteDirectConnectConnectionRequest';
