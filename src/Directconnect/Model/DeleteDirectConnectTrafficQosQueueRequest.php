...
class DeleteDirectConnectTrafficQosQueueRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteDirectConnectTrafficQosQueueRequest';
