...
class CreateBackupPolicyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateBackupPolicyRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enable_policy'] === null) {
            $invalidProperties[] = "'enable_policy' can't be null";
        }
