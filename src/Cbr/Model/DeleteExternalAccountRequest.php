...
class DeleteExternalAccountRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteExternalAccountRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_account_uid'] === null) {
            $invalidProperties[] = "'external_account_uid' can't be null";
        }
