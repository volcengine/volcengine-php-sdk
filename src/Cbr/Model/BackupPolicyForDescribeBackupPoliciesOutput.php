...
class BackupPolicyForDescribeBackupPoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BackupPolicyForDescribeBackupPoliciesOutput';
