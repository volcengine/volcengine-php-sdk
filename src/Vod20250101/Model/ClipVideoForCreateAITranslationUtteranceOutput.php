...
class ClipVideoForCreateAITranslationUtteranceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClipVideoForCreateAITranslationUtteranceOutput';
