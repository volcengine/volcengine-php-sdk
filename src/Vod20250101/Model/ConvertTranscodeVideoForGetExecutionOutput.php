...
class ConvertTranscodeVideoForGetExecutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertTranscodeVideoForGetExecutionOutput';
