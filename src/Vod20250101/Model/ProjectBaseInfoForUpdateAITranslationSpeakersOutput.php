...
class ProjectBaseInfoForUpdateAITranslationSpeakersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectBaseInfoForUpdateAITranslationSpeakersOutput';
