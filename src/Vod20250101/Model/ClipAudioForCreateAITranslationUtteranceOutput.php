...
class ClipAudioForCreateAITranslationUtteranceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClipAudioForCreateAITranslationUtteranceOutput';
