...
class ConvertBitrateControlForStartExecutionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertBitrateControlForStartExecutionInput';
