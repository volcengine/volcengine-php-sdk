...
class SpeakerForUpdateAITranslationSpeakersInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpeakerForUpdateAITranslationSpeakersInput';
