...
class SpeechForCreateAITranslationSpeechOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpeechForCreateAITranslationSpeechOutput';
