...
class OutputSubtitleForGetAITranslationProjectOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OutputSubtitleForGetAITranslationProjectOutput';
