...
class PreviewVideoForGetAITranslationProjectOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PreviewVideoForGetAITranslationProjectOutput';
