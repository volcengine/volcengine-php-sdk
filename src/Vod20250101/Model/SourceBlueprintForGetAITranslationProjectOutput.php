...
class SourceBlueprintForGetAITranslationProjectOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SourceBlueprintForGetAITranslationProjectOutput';
