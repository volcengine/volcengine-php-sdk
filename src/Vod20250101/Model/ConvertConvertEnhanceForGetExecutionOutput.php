...
class ConvertConvertEnhanceForGetExecutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertConvertEnhanceForGetExecutionOutput';
