...
class TargetClipForCreateAITranslationUtteranceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TargetClipForCreateAITranslationUtteranceOutput';
