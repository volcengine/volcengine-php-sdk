...
class ConvertConvertConvertEnhanceForGetExecutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertConvertConvertEnhanceForGetExecutionOutput';
