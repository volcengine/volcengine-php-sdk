...
class AuthorizedNetworkForCreateBranchInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizedNetworkForCreateBranchInput';
