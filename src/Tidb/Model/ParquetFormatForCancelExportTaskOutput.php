...
class ParquetFormatForCancelExportTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParquetFormatForCancelExportTaskOutput';
