...
class AutomatedBackupPolicyForGetClusterDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutomatedBackupPolicyForGetClusterDetailsOutput';
