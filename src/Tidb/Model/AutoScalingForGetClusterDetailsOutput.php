...
class AutoScalingForGetClusterDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoScalingForGetClusterDetailsOutput';
