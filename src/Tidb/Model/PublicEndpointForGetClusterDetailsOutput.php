...
class PublicEndpointForGetClusterDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicEndpointForGetClusterDetailsOutput';
