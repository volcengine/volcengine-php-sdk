...
class AutoScalingForListRecycledInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoScalingForListRecycledInstancesOutput';
