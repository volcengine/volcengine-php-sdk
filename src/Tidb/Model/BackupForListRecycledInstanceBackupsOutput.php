...
class BackupForListRecycledInstanceBackupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BackupForListRecycledInstanceBackupsOutput';
