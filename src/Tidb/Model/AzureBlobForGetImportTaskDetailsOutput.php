...
class AzureBlobForGetImportTaskDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AzureBlobForGetImportTaskDetailsOutput';
