...
class AuthorizedNetworkForListBranchesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizedNetworkForListBranchesOutput';
