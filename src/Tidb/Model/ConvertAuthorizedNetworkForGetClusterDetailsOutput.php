...
class ConvertAuthorizedNetworkForGetClusterDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertAuthorizedNetworkForGetClusterDetailsOutput';
