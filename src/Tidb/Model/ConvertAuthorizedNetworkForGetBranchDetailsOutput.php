...
class ConvertAuthorizedNetworkForGetBranchDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertAuthorizedNetworkForGetBranchDetailsOutput';
