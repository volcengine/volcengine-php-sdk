...
class ConvertAuthorizedNetworkForDeleteClusterOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertAuthorizedNetworkForDeleteClusterOutput';
