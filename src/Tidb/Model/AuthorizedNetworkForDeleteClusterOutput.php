...
class AuthorizedNetworkForDeleteClusterOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizedNetworkForDeleteClusterOutput';
