...
class ParquetFormatForDeleteExportTaskOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParquetFormatForDeleteExportTaskOutput';
