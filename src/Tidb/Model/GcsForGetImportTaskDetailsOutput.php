...
class GcsForGetImportTaskDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GcsForGetImportTaskDetailsOutput';
    ...
    public function __construct($data = null)
    {
        ...
        $this->container['service_account_key'] = isset($data['service_account_key']) ? $data['service_account_key'] : null;
     ...
     *
     * @param string $service_account_key service_account_key
     *
     * @return $this
     */
