...
class AuthorizedNetworkForGetBranchDetailsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizedNetworkForGetBranchDetailsOutput';
