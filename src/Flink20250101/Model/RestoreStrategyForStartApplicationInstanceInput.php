...
class RestoreStrategyForStartApplicationInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RestoreStrategyForStartApplicationInstanceInput';
