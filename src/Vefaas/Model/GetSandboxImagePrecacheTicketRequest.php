...
class GetSandboxImagePrecacheTicketRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSandboxImagePrecacheTicketRequest';
