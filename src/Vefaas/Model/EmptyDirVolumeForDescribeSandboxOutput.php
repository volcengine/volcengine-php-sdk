...
class EmptyDirVolumeForDescribeSandboxOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmptyDirVolumeForDescribeSandboxOutput';
