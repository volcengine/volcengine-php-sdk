...
class CancelSandboxImagePrecacheTicketRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CancelSandboxImagePrecacheTicketRequest';
