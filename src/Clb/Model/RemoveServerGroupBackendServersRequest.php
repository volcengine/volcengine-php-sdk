...
class RemoveServerGroupBackendServersRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RemoveServerGroupBackendServersRequest';
    ...
    {
        return $this->container['server_ids'];
    }

    /**
     * Sets server_ids
     *
     * @param string[] $server_ids server_ids
     *
     * @return $this
     */
    public function setServerIds($server_ids)
    {
        $this->container['server_ids'] = $server_ids;
