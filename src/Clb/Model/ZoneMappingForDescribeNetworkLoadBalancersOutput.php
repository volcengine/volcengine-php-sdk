...
class ZoneMappingForDescribeNetworkLoadBalancersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ZoneMappingForDescribeNetworkLoadBalancersOutput';
