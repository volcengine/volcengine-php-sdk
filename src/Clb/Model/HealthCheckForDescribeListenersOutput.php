...
class HealthCheckForDescribeListenersOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthCheckForDescribeListenersOutput';
