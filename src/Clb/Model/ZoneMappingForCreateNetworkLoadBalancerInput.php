...
class ZoneMappingForCreateNetworkLoadBalancerInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ZoneMappingForCreateNetworkLoadBalancerInput';
