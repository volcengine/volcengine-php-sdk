...
class DescribeNLBServerGroupAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeNLBServerGroupAttributesRequest';
