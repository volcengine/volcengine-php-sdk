...
class ListTagsForResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'tag_filters' => '\Volcengine\Clb\Model\TagFilterForListTagsForResourcesInput[]',
        'tag_type' => 'string'
    ];
    ...
    const RESOURCE_TYPE_CLB = 'CLB';
    const RESOURCE_TYPE_ACL = 'acl';
    const RESOURCE_TYPE_CERTIFICATE = 'certificate';
    const RESOURCE_TYPE_LISTENER = 'listener';
    const RESOURCE_TYPE_SERVERGROUP = 'servergroup';
    const RESOURCE_TYPE_RULE = 'rule';
    const RESOURCE_TYPE_EC = 'ec';
    ...
    {
        return [
            self::RESOURCE_TYPE_CLB,
            self::RESOURCE_TYPE_ACL,
            self::RESOURCE_TYPE_CERTIFICATE,
            self::RESOURCE_TYPE_LISTENER,
            self::RESOURCE_TYPE_SERVERGROUP,
            self::RESOURCE_TYPE_RULE,
            self::RESOURCE_TYPE_EC,
        ];
    }
     ...
     * Gets tag_filters
     *
     * @return \Volcengine\Clb\Model\TagFilterForListTagsForResourcesInput[]
     */
     ...
     * Sets tag_filters
     *
     * @param \Volcengine\Clb\Model\TagFilterForListTagsForResourcesInput[] $tag_filters tag_filters
     *
     * @return $this
     */
