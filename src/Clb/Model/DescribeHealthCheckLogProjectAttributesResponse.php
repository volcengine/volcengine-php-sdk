...
class DescribeHealthCheckLogProjectAttributesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeHealthCheckLogProjectAttributesResponse';
