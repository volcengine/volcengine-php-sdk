...
class EniAddressForDescribeLoadBalancerAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EniAddressForDescribeLoadBalancerAttributesOutput';
