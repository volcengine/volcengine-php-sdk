...
class HealthCheckForCreateNLBServerGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthCheckForCreateNLBServerGroupInput';
