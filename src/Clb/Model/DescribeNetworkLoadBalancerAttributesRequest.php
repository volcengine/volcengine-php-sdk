...
class DescribeNetworkLoadBalancerAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeNetworkLoadBalancerAttributesRequest';
