...
class HealthCheckForModifyNLBServerGroupAttributesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthCheckForModifyNLBServerGroupAttributesInput';
