...
class DescribeHealthCheckLogTopicAttributesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeHealthCheckLogTopicAttributesResponse';
