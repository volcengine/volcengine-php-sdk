...
class EipForDescribeLoadBalancerAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipForDescribeLoadBalancerAttributesOutput';
