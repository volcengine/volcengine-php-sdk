...
class ServerGroupForDescribeLoadBalancerAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerGroupForDescribeLoadBalancerAttributesOutput';
