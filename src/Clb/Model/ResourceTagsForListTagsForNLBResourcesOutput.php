...
class ResourceTagsForListTagsForNLBResourcesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceTagsForListTagsForNLBResourcesOutput';
