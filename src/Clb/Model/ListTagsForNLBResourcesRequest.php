...
class ListTagsForNLBResourcesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListTagsForNLBResourcesRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'tag_filters' => '\Volcengine\Clb\Model\TagFilterForListTagsForNLBResourcesInput[]',
        'tag_type' => 'string'
    ];
    ...
    const RESOURCE_TYPE_NLB = 'nlb';
    const RESOURCE_TYPE_NLB_LISTENER = 'nlb_listener';
    const RESOURCE_TYPE_NLB_SERVERGROUP = 'nlb_servergroup';
    const RESOURCE_TYPE_NLB_SECURITY_POLICY = 'nlb_security_policy';
    const TAG_TYPE_CUSTOM = 'custom';
    const TAG_TYPE_SYSTEM = 'system';
    ...
    {
        return [
            self::RESOURCE_TYPE_NLB,
            self::RESOURCE_TYPE_NLB_LISTENER,
            self::RESOURCE_TYPE_NLB_SERVERGROUP,
            self::RESOURCE_TYPE_NLB_SECURITY_POLICY,
        ];
    }
     ...
     * Gets tag_filters
     *
     * @return \Volcengine\Clb\Model\TagFilterForListTagsForNLBResourcesInput[]
     */
     ...
     * Sets tag_filters
     *
     * @param \Volcengine\Clb\Model\TagFilterForListTagsForNLBResourcesInput[] $tag_filters tag_filters
     *
     * @return $this
     */
