...
class DescribeHealthCheckLogTopicAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeHealthCheckLogTopicAttributesRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['log_topic_id'] === null) {
            $invalidProperties[] = "'log_topic_id' can't be null";
        }
