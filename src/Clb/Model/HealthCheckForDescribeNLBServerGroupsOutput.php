...
class HealthCheckForDescribeNLBServerGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthCheckForDescribeNLBServerGroupsOutput';
