...
class ModifyNetworkLoadBalancerSecurityGroupsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyNetworkLoadBalancerSecurityGroupsRequest';
