...
class ModifyNLBSecurityPolicyAttributesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyNLBSecurityPolicyAttributesRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['security_policy_id'] === null) {
            $invalidProperties[] = "'security_policy_id' can't be null";
        }
