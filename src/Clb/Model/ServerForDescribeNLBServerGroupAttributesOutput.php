...
class ServerForDescribeNLBServerGroupAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ServerForDescribeNLBServerGroupAttributesOutput';
