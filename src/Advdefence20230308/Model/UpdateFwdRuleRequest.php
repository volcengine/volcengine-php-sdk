...
class UpdateFwdRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateFwdRuleRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fwd_port'] === null) {
            $invalidProperties[] = "'fwd_port' can't be null";
        }
        ...
        if ($this->container['src_port'] === null) {
            $invalidProperties[] = "'src_port' can't be null";
        }
