...
class ConvertCompressionActionForDescribeVodDomainConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertCompressionActionForDescribeVodDomainConfigOutput';
    ...
    {
        $this->container['compression_ratio'] = isset($data['compression_ratio']) ? $data['compression_ratio'] : null;
     ...
     *
     * @param int $compression_ratio compression_ratio
     *
     * @return $this
     */
