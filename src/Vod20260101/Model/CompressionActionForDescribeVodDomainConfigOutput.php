...
class CompressionActionForDescribeVodDomainConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CompressionActionForDescribeVodDomainConfigOutput';
