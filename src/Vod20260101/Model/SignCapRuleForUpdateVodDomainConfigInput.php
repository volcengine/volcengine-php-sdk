...
class SignCapRuleForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignCapRuleForUpdateVodDomainConfigInput';
