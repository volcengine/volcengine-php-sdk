...
class MethodDeniedRuleForAddVodDomainInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MethodDeniedRuleForAddVodDomainInput';
