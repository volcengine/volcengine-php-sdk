...
class ErrorPageActionForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ErrorPageActionForUpdateVodDomainConfigInput';
