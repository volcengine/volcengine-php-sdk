...
class AreaAccessRuleForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AreaAccessRuleForUpdateVodDomainConfigInput';
