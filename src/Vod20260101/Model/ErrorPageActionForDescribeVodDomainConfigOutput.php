...
class ErrorPageActionForDescribeVodDomainConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ErrorPageActionForDescribeVodDomainConfigOutput';
