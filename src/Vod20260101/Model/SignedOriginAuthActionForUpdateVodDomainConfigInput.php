...
class SignedOriginAuthActionForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SignedOriginAuthActionForUpdateVodDomainConfigInput';
