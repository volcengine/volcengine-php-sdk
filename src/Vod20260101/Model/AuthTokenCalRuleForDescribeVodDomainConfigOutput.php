...
class AuthTokenCalRuleForDescribeVodDomainConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthTokenCalRuleForDescribeVodDomainConfigOutput';
