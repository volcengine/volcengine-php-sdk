...
class RewriteMPDForDescribeVodDomainConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RewriteMPDForDescribeVodDomainConfigOutput';
