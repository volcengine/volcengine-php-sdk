...
class CacheKeyComponentForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CacheKeyComponentForUpdateVodDomainConfigInput';
