...
class ParentLinkUriParamSupForAddVodDomainInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParentLinkUriParamSupForAddVodDomainInput';
