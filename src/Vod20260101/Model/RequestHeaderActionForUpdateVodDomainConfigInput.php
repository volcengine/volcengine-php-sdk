...
class RequestHeaderActionForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RequestHeaderActionForUpdateVodDomainConfigInput';
