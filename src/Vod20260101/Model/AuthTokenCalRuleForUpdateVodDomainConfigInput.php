...
class AuthTokenCalRuleForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthTokenCalRuleForUpdateVodDomainConfigInput';
