...
class OriginRewriteActionForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OriginRewriteActionForUpdateVodDomainConfigInput';
