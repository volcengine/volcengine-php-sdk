...
class ParentLinkUriParamSupForUpdateVodDomainConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ParentLinkUriParamSupForUpdateVodDomainConfigInput';
