...
class CertCheckForDescribeVodDomainConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CertCheckForDescribeVodDomainConfigOutput';
