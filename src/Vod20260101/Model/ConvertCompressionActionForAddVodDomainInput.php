...
class ConvertCompressionActionForAddVodDomainInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertCompressionActionForAddVodDomainInput';
