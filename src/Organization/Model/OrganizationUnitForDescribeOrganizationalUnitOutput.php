...
class OrganizationUnitForDescribeOrganizationalUnitOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrganizationUnitForDescribeOrganizationalUnitOutput';
