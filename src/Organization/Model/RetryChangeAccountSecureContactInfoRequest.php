...
class RetryChangeAccountSecureContactInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RetryChangeAccountSecureContactInfoRequest';
