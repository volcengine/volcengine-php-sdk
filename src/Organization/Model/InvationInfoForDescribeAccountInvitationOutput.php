...
class InvationInfoForDescribeAccountInvitationOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvationInfoForDescribeAccountInvitationOutput';
