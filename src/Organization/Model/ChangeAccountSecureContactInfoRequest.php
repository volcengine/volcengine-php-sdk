...
class ChangeAccountSecureContactInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChangeAccountSecureContactInfoRequest';
