...
class ResourceTagForListTagResourcesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceTagForListTagResourcesOutput';
