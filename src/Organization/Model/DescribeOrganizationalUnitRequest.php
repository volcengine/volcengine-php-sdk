...
class DescribeOrganizationalUnitRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeOrganizationalUnitRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['org_unit_id'] === null) {
            $invalidProperties[] = "'org_unit_id' can't be null";
        }
