...
class EipAddressForDescribeNatGatewayAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipAddressForDescribeNatGatewayAttributesOutput';
