...
class EipAddressForDescribeNatGatewaysOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipAddressForDescribeNatGatewaysOutput';
