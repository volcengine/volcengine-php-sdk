...
class RagDetailForGetAlarmDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RagDetailForGetAlarmDetailOutput';
    ...
    {
        $this->container['inference'] = isset($data['inference']) ? $data['inference'] : null;
