...
class AddIMConfigRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddIMConfigRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['rebot_name'] === null) {
            $invalidProperties[] = "'rebot_name' can't be null";
        }
