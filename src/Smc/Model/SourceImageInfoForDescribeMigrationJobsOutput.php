...
class SourceImageInfoForDescribeMigrationJobsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SourceImageInfoForDescribeMigrationJobsOutput';
