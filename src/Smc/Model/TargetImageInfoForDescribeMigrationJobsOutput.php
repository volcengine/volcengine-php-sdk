...
class TargetImageInfoForDescribeMigrationJobsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TargetImageInfoForDescribeMigrationJobsOutput';
