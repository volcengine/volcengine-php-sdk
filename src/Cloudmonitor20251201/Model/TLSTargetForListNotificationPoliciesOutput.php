...
class TLSTargetForListNotificationPoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TLSTargetForListNotificationPoliciesOutput';
