...
class TimeRangeForUpdateSilencePolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TimeRangeForUpdateSilencePolicyInput';
