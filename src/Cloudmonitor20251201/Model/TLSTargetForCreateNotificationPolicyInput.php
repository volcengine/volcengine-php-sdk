...
class TLSTargetForCreateNotificationPolicyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TLSTargetForCreateNotificationPolicyInput';
