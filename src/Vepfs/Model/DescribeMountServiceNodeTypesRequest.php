...
class DescribeMountServiceNodeTypesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeMountServiceNodeTypesRequest';
