...
class AddressForDescribeDBBlueGreenDifferencesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddressForDescribeDBBlueGreenDifferencesInput';
