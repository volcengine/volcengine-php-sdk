...
class ChargeInfoForDescribeResourcePackagePriceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeInfoForDescribeResourcePackagePriceInput';
