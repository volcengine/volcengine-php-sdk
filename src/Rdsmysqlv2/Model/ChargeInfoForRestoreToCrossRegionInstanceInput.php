...
class ChargeInfoForRestoreToCrossRegionInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeInfoForRestoreToCrossRegionInstanceInput';
