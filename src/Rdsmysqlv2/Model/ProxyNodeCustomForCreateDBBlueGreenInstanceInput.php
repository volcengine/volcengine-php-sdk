...
class ProxyNodeCustomForCreateDBBlueGreenInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProxyNodeCustomForCreateDBBlueGreenInstanceInput';
