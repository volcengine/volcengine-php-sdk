...
class NodeForDescribeDBInstanceHAConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeForDescribeDBInstanceHAConfigOutput';
