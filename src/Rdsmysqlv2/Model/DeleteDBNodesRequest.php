...
class DeleteDBNodesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteDBNodesRequest';
    ...
    {
        return $this->container['db_node_ids'];
    }

    /**
     * Sets db_node_ids
     *
     * @param string[] $db_node_ids db_node_ids
     *
     * @return $this
     */
    public function setDbNodeIds($db_node_ids)
    {
        $this->container['db_node_ids'] = $db_node_ids;
