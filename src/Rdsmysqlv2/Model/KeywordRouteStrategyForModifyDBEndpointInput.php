...
class KeywordRouteStrategyForModifyDBEndpointInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeywordRouteStrategyForModifyDBEndpointInput';
