...
class ProxyNodeCustomForRebuildDBInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProxyNodeCustomForRebuildDBInstanceInput';
