...
class ColumnInfoForDescribeDbAccountTableColumnInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ColumnInfoForDescribeDbAccountTableColumnInfoOutput';
