...
class ModifyDBInstanceGlobalReadOnlyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyDBInstanceGlobalReadOnlyRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['global_read_only'] === null) {
            $invalidProperties[] = "'global_read_only' can't be null";
        }
