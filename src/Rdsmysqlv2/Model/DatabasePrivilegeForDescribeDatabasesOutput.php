...
class DatabasePrivilegeForDescribeDatabasesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DatabasePrivilegeForDescribeDatabasesOutput';
