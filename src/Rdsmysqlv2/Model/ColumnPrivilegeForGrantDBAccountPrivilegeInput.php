...
class ColumnPrivilegeForGrantDBAccountPrivilegeInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ColumnPrivilegeForGrantDBAccountPrivilegeInput';
