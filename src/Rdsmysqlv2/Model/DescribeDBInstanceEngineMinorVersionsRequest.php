...
class DescribeDBInstanceEngineMinorVersionsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeDBInstanceEngineMinorVersionsRequest';
