...
class ReadOnlyNodeWeightForCreateDBEndpointInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReadOnlyNodeWeightForCreateDBEndpointInput';
