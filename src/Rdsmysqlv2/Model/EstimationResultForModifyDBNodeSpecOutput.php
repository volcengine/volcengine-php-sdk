...
class EstimationResultForModifyDBNodeSpecOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EstimationResultForModifyDBNodeSpecOutput';
