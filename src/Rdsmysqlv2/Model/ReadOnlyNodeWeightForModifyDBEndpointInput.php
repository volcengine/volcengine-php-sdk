...
class ReadOnlyNodeWeightForModifyDBEndpointInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReadOnlyNodeWeightForModifyDBEndpointInput';
