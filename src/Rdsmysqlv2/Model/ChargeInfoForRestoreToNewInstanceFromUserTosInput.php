...
class ChargeInfoForRestoreToNewInstanceFromUserTosInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeInfoForRestoreToNewInstanceFromUserTosInput';
