...
class RegionForDescribeDisasterRecoveryRegionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RegionForDescribeDisasterRecoveryRegionsOutput';
