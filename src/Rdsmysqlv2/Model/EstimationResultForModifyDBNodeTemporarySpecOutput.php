...
class EstimationResultForModifyDBNodeTemporarySpecOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EstimationResultForModifyDBNodeTemporarySpecOutput';
