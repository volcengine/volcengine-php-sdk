...
class TablePrivilegeForGrantDBAccountPrivilegeInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TablePrivilegeForGrantDBAccountPrivilegeInput';
