...
class FeatureStateForDescribeDBProxyConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FeatureStateForDescribeDBProxyConfigOutput';
