...
class TablePrivilegeForCreateDBAccountInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TablePrivilegeForCreateDBAccountInput';
