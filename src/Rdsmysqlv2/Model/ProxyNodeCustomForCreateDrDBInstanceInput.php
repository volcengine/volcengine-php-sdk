...
class ProxyNodeCustomForCreateDrDBInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProxyNodeCustomForCreateDrDBInstanceInput';
