...
class ProxyNodeCustomForModifyDBProxySpecInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProxyNodeCustomForModifyDBProxySpecInput';
