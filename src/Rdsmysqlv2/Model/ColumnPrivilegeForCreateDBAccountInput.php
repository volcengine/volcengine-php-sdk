...
class ColumnPrivilegeForCreateDBAccountInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ColumnPrivilegeForCreateDBAccountInput';
