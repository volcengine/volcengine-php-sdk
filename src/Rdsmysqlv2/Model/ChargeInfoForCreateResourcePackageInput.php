...
class ChargeInfoForCreateResourcePackageInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeInfoForCreateResourcePackageInput';
