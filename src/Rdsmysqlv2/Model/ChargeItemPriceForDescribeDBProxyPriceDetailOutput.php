...
class ChargeItemPriceForDescribeDBProxyPriceDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeItemPriceForDescribeDBProxyPriceDetailOutput';
