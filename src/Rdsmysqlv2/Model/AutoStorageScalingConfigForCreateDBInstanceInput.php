...
class AutoStorageScalingConfigForCreateDBInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoStorageScalingConfigForCreateDBInstanceInput';
