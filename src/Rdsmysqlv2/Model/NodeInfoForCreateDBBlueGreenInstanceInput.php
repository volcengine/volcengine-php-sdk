...
class NodeInfoForCreateDBBlueGreenInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeInfoForCreateDBBlueGreenInstanceInput';
