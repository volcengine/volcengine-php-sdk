...
class ProxyNodeCustomForRestoreToCrossRegionInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProxyNodeCustomForRestoreToCrossRegionInstanceInput';
