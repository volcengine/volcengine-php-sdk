...
class AutoStorageScalingConfigForCreateDrDBInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutoStorageScalingConfigForCreateDrDBInstanceInput';
