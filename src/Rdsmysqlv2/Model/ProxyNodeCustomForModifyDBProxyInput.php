...
class ProxyNodeCustomForModifyDBProxyInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProxyNodeCustomForModifyDBProxyInput';
