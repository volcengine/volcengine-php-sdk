...
class NodeInfoForModifyDBNodeTemporarySpecInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeInfoForModifyDBNodeTemporarySpecInput';
