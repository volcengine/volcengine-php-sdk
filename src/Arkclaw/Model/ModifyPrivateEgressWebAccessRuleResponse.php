...
class ModifyPrivateEgressWebAccessRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyPrivateEgressWebAccessRuleResponse';
