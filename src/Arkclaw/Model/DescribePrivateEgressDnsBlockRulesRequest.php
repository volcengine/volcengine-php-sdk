...
class DescribePrivateEgressDnsBlockRulesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribePrivateEgressDnsBlockRulesRequest';
