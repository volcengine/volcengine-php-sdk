...
class ResultDeliveryForGetScheduledJobOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResultDeliveryForGetScheduledJobOutput';
