...
class StopClawOmniInstanceCommandJobRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StopClawOmniInstanceCommandJobRequest';
