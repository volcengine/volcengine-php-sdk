...
class CreateScheduledJobRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateScheduledJobRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['schedule_expr'] === null) {
            $invalidProperties[] = "'schedule_expr' can't be null";
        }
