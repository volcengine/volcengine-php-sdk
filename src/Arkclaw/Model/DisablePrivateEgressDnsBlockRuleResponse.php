...
class DisablePrivateEgressDnsBlockRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DisablePrivateEgressDnsBlockRuleResponse';
