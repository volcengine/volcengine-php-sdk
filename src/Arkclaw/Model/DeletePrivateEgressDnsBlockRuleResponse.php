...
class DeletePrivateEgressDnsBlockRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeletePrivateEgressDnsBlockRuleResponse';
