...
class DeletePrivateEgressNetworkAccessRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeletePrivateEgressNetworkAccessRuleResponse';
