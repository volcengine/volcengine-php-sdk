...
class ModelConfigForUpdateClawOmniInstanceModelInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModelConfigForUpdateClawOmniInstanceModelInput';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['model_source'] === null) {
            $invalidProperties[] = "'model_source' can't be null";
        }
