...
class CreatePrivateEgressDnsBlockRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreatePrivateEgressDnsBlockRuleResponse';
