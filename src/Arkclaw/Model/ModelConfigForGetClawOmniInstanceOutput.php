...
class ModelConfigForGetClawOmniInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModelConfigForGetClawOmniInstanceOutput';
