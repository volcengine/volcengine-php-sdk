...
class ModifyPrivateEgressDnsBlockRuleResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyPrivateEgressDnsBlockRuleResponse';
