...
class ModelForListClawOmniSpaceEnabledModelsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModelForListClawOmniSpaceEnabledModelsOutput';
