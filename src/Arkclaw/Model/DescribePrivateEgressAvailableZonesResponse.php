...
class DescribePrivateEgressAvailableZonesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribePrivateEgressAvailableZonesResponse';
