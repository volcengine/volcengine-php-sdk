...
class EnablePrivateEgressDnsBlockRuleRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnablePrivateEgressDnsBlockRuleRequest';
