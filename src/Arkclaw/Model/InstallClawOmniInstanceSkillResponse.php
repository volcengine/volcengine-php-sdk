...
class InstallClawOmniInstanceSkillResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstallClawOmniInstanceSkillResponse';
