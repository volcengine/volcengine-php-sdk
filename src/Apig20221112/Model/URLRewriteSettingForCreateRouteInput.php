...
class URLRewriteSettingForCreateRouteInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'URLRewriteSettingForCreateRouteInput';
