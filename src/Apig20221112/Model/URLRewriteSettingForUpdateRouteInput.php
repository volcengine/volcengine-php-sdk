...
class URLRewriteSettingForUpdateRouteInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'URLRewriteSettingForUpdateRouteInput';
