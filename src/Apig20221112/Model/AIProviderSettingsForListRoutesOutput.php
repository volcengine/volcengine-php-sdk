...
class AIProviderSettingsForListRoutesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AIProviderSettingsForListRoutesOutput';
