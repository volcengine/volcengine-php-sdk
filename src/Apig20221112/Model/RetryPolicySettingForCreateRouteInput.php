...
class RetryPolicySettingForCreateRouteInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RetryPolicySettingForCreateRouteInput';
