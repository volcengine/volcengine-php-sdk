...
class PurchaseReservedStorageCapacityResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PurchaseReservedStorageCapacityResponse';
