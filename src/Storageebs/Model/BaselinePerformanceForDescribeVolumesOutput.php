...
class BaselinePerformanceForDescribeVolumesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BaselinePerformanceForDescribeVolumesOutput';
