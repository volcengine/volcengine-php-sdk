...
class ChargeDetailForDescribeInstanceDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeDetailForDescribeInstanceDetailOutput';
