...
class ChargeInfoForModifyInstanceChargeTypeInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeInfoForModifyInstanceChargeTypeInput';
