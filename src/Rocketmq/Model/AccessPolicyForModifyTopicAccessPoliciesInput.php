...
class AccessPolicyForModifyTopicAccessPoliciesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccessPolicyForModifyTopicAccessPoliciesInput';
