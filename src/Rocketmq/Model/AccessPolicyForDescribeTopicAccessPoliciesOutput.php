...
class AccessPolicyForDescribeTopicAccessPoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccessPolicyForDescribeTopicAccessPoliciesOutput';
