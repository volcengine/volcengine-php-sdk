...
class AccessPolicyForCreateTopicAsyncInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccessPolicyForCreateTopicAsyncInput';
