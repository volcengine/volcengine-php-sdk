...
class ConsumedTopicsInfoForDescribeConsumedTopicsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConsumedTopicsInfoForDescribeConsumedTopicsOutput';
