...
class MessageListForQueryMessageByMsgKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageListForQueryMessageByMsgKeyOutput';
