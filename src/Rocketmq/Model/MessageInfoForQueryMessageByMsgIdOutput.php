...
class MessageInfoForQueryMessageByMsgIdOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageInfoForQueryMessageByMsgIdOutput';
