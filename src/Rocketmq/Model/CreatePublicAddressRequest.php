...
class CreatePublicAddressRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreatePublicAddressRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['eip_id'] === null) {
            $invalidProperties[] = "'eip_id' can't be null";
        }
