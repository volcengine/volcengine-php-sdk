...
class TerminatePublicBandwidthPackageRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TerminatePublicBandwidthPackageRequest';
