...
class PublicBandwidthPackageBindBasicAcceleratorRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicBandwidthPackageBindBasicAcceleratorRequest';
