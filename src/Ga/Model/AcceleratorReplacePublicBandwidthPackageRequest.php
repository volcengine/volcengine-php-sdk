...
class AcceleratorReplacePublicBandwidthPackageRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AcceleratorReplacePublicBandwidthPackageRequest';
