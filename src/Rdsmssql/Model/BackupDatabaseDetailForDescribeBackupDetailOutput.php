...
class BackupDatabaseDetailForDescribeBackupDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BackupDatabaseDetailForDescribeBackupDetailOutput';
