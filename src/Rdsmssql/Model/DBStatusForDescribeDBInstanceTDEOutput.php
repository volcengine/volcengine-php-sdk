...
class DBStatusForDescribeDBInstanceTDEOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DBStatusForDescribeDBInstanceTDEOutput';
