...
class DescribeTosRestoreTaskDetailRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeTosRestoreTaskDetailRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['restore_task_id'] === null) {
            $invalidProperties[] = "'restore_task_id' can't be null";
        }
