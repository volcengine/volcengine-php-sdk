...
class UnhandledForGetSOCAssetVulnStatsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UnhandledForGetSOCAssetVulnStatsOutput';
