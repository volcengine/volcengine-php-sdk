...
class BaseAlarmInfoForGetHidsAlarmInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BaseAlarmInfoForGetHidsAlarmInfoOutput';
