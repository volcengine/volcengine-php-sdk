...
class DataForListAIApplicationBasicInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForListAIApplicationBasicInfoOutput';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['vuln_num'] = isset($data['vuln_num']) ? $data['vuln_num'] : null;
    }
     ...
     * @return int
     */
    public function getVulnNum()
    {
        return $this->container['vuln_num'];
    }

    /**
     * Sets vuln_num
     *
     * @param int $vuln_num vuln_num
     *
     * @return $this
     */
    public function setVulnNum($vuln_num)
    {
        $this->container['vuln_num'] = $vuln_num;
