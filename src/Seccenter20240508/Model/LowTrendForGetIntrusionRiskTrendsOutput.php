...
class LowTrendForGetIntrusionRiskTrendsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LowTrendForGetIntrusionRiskTrendsOutput';
