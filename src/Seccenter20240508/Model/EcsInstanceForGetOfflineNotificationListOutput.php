...
class EcsInstanceForGetOfflineNotificationListOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EcsInstanceForGetOfflineNotificationListOutput';
