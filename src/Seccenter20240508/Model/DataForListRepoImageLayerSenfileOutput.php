...
class DataForListRepoImageLayerSenfileOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForListRepoImageLayerSenfileOutput';
