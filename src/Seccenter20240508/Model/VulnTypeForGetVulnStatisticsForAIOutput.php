...
class VulnTypeForGetVulnStatisticsForAIOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VulnTypeForGetVulnStatisticsForAIOutput';
