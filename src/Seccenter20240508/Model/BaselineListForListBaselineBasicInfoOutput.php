...
class BaselineListForListBaselineBasicInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BaselineListForListBaselineBasicInfoOutput';
