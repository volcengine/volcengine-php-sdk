...
class GetMultiLevelHostAssetOverviewRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetMultiLevelHostAssetOverviewRequest';
