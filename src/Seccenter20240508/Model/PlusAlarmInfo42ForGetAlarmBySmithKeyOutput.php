...
class PlusAlarmInfo42ForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo42ForGetAlarmBySmithKeyOutput';
