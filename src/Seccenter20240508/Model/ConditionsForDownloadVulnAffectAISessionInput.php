...
class ConditionsForDownloadVulnAffectAISessionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionsForDownloadVulnAffectAISessionInput';
