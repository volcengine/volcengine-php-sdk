...
class DataForGetMLPAssetSyncTaskDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForGetMLPAssetSyncTaskDetailOutput';
