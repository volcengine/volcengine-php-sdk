...
class ProcListForListEndpointHandleMethodsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcListForListEndpointHandleMethodsOutput';
