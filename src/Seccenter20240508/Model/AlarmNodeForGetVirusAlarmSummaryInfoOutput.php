...
class AlarmNodeForGetVirusAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlarmNodeForGetVirusAlarmSummaryInfoOutput';
