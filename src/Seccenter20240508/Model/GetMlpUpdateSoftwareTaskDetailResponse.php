...
class GetMlpUpdateSoftwareTaskDetailResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetMlpUpdateSoftwareTaskDetailResponse';
