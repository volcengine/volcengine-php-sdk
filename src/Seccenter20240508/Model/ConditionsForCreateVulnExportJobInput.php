...
class ConditionsForCreateVulnExportJobInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionsForCreateVulnExportJobInput';
