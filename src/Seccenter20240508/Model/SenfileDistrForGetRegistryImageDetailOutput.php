...
class SenfileDistrForGetRegistryImageDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SenfileDistrForGetRegistryImageDetailOutput';
