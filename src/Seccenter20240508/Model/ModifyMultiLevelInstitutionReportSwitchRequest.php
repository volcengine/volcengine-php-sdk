...
class ModifyMultiLevelInstitutionReportSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyMultiLevelInstitutionReportSwitchRequest';
