...
class UnhandledForGetSOCAssetAlarmStatsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UnhandledForGetSOCAssetAlarmStatsOutput';
