...
class GetRepoRegistryVpcAuthCreateInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetRepoRegistryVpcAuthCreateInfoRequest';
