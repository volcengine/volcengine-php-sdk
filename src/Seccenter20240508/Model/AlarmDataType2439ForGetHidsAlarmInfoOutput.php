...
class AlarmDataType2439ForGetHidsAlarmInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlarmDataType2439ForGetHidsAlarmInfoOutput';
