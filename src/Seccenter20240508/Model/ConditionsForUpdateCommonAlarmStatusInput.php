...
class ConditionsForUpdateCommonAlarmStatusInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionsForUpdateCommonAlarmStatusInput';
