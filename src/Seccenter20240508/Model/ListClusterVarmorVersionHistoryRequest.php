...
class ListClusterVarmorVersionHistoryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListClusterVarmorVersionHistoryRequest';
