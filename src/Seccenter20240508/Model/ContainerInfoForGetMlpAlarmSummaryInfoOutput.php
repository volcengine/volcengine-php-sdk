...
class ContainerInfoForGetMlpAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContainerInfoForGetMlpAlarmSummaryInfoOutput';
