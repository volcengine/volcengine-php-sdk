...
class JudgeAlarmBySecurityIntelligenceRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JudgeAlarmBySecurityIntelligenceRequest';
