...
class DataForListCheckConfigRelatedBaselineOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForListCheckConfigRelatedBaselineOutput';
