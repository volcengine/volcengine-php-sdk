...
class ProcessStartTopicConfigForGetTLSInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcessStartTopicConfigForGetTLSInfoOutput';
