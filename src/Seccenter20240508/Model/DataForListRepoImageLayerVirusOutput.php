...
class DataForListRepoImageLayerVirusOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForListRepoImageLayerVirusOutput';
