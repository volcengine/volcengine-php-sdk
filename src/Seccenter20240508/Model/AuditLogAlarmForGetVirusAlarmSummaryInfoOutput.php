...
class AuditLogAlarmForGetVirusAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuditLogAlarmForGetVirusAlarmSummaryInfoOutput';
