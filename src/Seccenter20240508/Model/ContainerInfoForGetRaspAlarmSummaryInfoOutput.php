...
class ContainerInfoForGetRaspAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContainerInfoForGetRaspAlarmSummaryInfoOutput';
