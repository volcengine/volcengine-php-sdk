...
class PlusAlarmInfo42ForGetHidsAlarmInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo42ForGetHidsAlarmInfoOutput';
