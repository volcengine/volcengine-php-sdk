...
class PlusAlarmInfo6003ForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo6003ForGetAlarmBySmithKeyOutput';
