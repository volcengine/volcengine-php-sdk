...
class PolicyForListAutoHardeningConfigsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyForListAutoHardeningConfigsOutput';
