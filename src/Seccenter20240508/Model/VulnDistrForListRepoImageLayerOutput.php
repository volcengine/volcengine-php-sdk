...
class VulnDistrForListRepoImageLayerOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VulnDistrForListRepoImageLayerOutput';
