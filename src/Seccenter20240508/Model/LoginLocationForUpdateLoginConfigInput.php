...
class LoginLocationForUpdateLoginConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LoginLocationForUpdateLoginConfigInput';
