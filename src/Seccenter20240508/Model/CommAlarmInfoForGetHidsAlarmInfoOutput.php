...
class CommAlarmInfoForGetHidsAlarmInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommAlarmInfoForGetHidsAlarmInfoOutput';
