...
class AuditLogAlarmForGetRaspAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuditLogAlarmForGetRaspAlarmSummaryInfoOutput';
