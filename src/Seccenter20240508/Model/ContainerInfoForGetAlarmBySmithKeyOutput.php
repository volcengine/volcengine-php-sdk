...
class ContainerInfoForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContainerInfoForGetAlarmBySmithKeyOutput';
