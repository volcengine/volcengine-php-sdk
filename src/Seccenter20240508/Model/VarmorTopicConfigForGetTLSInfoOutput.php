...
class VarmorTopicConfigForGetTLSInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VarmorTopicConfigForGetTLSInfoOutput';
