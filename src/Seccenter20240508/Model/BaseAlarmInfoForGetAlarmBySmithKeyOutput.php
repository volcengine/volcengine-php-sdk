...
class BaseAlarmInfoForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BaseAlarmInfoForGetAlarmBySmithKeyOutput';
