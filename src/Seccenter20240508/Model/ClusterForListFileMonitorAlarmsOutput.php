...
class ClusterForListFileMonitorAlarmsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClusterForListFileMonitorAlarmsOutput';
