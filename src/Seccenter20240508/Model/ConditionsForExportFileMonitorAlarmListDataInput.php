...
class ConditionsForExportFileMonitorAlarmListDataInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionsForExportFileMonitorAlarmListDataInput';
