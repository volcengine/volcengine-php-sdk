...
class PlusAlarmInfo702ForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo702ForGetAlarmBySmithKeyOutput';
