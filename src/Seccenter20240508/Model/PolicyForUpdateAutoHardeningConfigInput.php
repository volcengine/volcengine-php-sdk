...
class PolicyForUpdateAutoHardeningConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyForUpdateAutoHardeningConfigInput';
