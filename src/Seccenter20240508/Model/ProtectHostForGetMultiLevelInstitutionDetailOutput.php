...
class ProtectHostForGetMultiLevelInstitutionDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProtectHostForGetMultiLevelInstitutionDetailOutput';
