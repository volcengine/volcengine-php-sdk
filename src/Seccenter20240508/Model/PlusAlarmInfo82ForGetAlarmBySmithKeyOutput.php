...
class PlusAlarmInfo82ForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo82ForGetAlarmBySmithKeyOutput';
