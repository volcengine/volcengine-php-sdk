...
class SenfileDistrForListRepoImageLayerOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SenfileDistrForListRepoImageLayerOutput';
