...
class DataForGetAIFingerprintProcessOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForGetAIFingerprintProcessOutput';
