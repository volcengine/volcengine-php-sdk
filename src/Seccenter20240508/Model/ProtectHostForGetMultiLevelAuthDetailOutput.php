...
class ProtectHostForGetMultiLevelAuthDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProtectHostForGetMultiLevelAuthDetailOutput';
