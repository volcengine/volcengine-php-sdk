...
class PlusAlarmInfo700ForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo700ForGetAlarmBySmithKeyOutput';
