...
class FilterForListRegistryNamespaceIDsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FilterForListRegistryNamespaceIDsInput';
