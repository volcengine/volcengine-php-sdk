...
class RiskForListMultiLevelAssetHostsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RiskForListMultiLevelAssetHostsOutput';
