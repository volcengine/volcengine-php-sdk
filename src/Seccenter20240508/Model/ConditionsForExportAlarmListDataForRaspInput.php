...
class ConditionsForExportAlarmListDataForRaspInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionsForExportAlarmListDataForRaspInput';
