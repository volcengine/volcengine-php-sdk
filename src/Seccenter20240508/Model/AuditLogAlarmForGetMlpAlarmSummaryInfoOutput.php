...
class AuditLogAlarmForGetMlpAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuditLogAlarmForGetMlpAlarmSummaryInfoOutput';
