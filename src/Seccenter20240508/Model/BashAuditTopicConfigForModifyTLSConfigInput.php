...
class BashAuditTopicConfigForModifyTLSConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BashAuditTopicConfigForModifyTLSConfigInput';
