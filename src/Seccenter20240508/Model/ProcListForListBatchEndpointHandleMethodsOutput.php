...
class ProcListForListBatchEndpointHandleMethodsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcListForListBatchEndpointHandleMethodsOutput';
