...
class DataForListAutoHardeningPoliciesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForListAutoHardeningPoliciesOutput';
