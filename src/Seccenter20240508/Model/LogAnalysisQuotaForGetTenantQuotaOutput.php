...
class LogAnalysisQuotaForGetTenantQuotaOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LogAnalysisQuotaForGetTenantQuotaOutput';
