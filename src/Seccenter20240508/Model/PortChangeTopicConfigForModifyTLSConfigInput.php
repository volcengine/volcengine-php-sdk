...
class PortChangeTopicConfigForModifyTLSConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PortChangeTopicConfigForModifyTLSConfigInput';
