...
class HighTrendForGetIntrusionRiskTrendsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HighTrendForGetIntrusionRiskTrendsOutput';
