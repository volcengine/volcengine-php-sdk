...
class ConditionsForUpdateMlpAlarmStatusInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionsForUpdateMlpAlarmStatusInput';
