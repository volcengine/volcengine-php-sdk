...
class PlusAlarmInfo86ForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo86ForGetAlarmBySmithKeyOutput';
