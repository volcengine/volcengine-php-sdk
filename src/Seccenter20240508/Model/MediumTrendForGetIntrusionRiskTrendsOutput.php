...
class MediumTrendForGetIntrusionRiskTrendsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MediumTrendForGetIntrusionRiskTrendsOutput';
