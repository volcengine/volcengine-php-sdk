...
class PlusAlarmInfo703ForGetAlarmBySmithKeyOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlusAlarmInfo703ForGetAlarmBySmithKeyOutput';
