...
class AlarmDescForGetVirusAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AlarmDescForGetVirusAlarmSummaryInfoOutput';
