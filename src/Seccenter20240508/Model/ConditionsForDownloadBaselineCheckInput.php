...
class ConditionsForDownloadBaselineCheckInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConditionsForDownloadBaselineCheckInput';
