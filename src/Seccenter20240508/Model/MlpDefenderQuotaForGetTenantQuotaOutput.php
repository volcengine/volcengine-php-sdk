...
class MlpDefenderQuotaForGetTenantQuotaOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MlpDefenderQuotaForGetTenantQuotaOutput';
