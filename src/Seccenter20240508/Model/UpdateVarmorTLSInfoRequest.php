...
class UpdateVarmorTLSInfoRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateVarmorTLSInfoRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['storage_days'] === null) {
            $invalidProperties[] = "'storage_days' can't be null";
        }
