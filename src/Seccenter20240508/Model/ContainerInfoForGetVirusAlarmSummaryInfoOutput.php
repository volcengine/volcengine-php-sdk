...
class ContainerInfoForGetVirusAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContainerInfoForGetVirusAlarmSummaryInfoOutput';
