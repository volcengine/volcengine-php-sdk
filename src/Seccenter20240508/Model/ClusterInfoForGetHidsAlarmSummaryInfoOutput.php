...
class ClusterInfoForGetHidsAlarmSummaryInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClusterInfoForGetHidsAlarmSummaryInfoOutput';
