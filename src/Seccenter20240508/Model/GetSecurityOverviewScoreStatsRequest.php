...
class GetSecurityOverviewScoreStatsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetSecurityOverviewScoreStatsRequest';
