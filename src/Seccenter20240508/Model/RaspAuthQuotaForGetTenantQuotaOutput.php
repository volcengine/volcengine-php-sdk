...
class RaspAuthQuotaForGetTenantQuotaOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RaspAuthQuotaForGetTenantQuotaOutput';
