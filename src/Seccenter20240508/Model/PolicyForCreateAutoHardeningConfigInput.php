...
class PolicyForCreateAutoHardeningConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PolicyForCreateAutoHardeningConfigInput';
