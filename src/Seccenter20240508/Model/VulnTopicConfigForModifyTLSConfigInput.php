...
class VulnTopicConfigForModifyTLSConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VulnTopicConfigForModifyTLSConfigInput';
