...
class InjectConfigListForListRaspConfigsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InjectConfigListForListRaspConfigsOutput';
