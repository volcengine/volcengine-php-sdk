...
class ContainerInfoForGetHidsAlarmInfoOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContainerInfoForGetHidsAlarmInfoOutput';
