...
class DataForListAssetPodsLinkedWorkloadWithNoPageOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForListAssetPodsLinkedWorkloadWithNoPageOutput';
