...
class DataForListFingerprintCollectConfigOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataForListFingerprintCollectConfigOutput';
