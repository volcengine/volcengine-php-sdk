...
class GetManualSyncAIApplicationStatusResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetManualSyncAIApplicationStatusResponse';
