...
class NodeSupportSpecListForDescribeAvailableSpecOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeSupportSpecListForDescribeAvailableSpecOutput';
