...
class VpcInfoForMSCreateInstanceOneStepInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VpcInfoForMSCreateInstanceOneStepInput';
