...
class ConfigAssignListForModifyInstanceConfigInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfigAssignListForModifyInstanceConfigInput';
