...
class ChargeConfigForMSDescribeInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeConfigForMSDescribeInstancesOutput';
