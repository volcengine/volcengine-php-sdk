...
class ChargeConfigForDescribeInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeConfigForDescribeInstancesOutput';
