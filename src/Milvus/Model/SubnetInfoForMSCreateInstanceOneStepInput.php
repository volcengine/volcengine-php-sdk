...
class SubnetInfoForMSCreateInstanceOneStepInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubnetInfoForMSCreateInstanceOneStepInput';
