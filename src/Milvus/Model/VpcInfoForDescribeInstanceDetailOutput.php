...
class VpcInfoForDescribeInstanceDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VpcInfoForDescribeInstanceDetailOutput';
