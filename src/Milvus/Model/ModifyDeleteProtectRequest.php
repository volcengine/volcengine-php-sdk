...
class ModifyDeleteProtectRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyDeleteProtectRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['delete_protect_enabled'] === null) {
            $invalidProperties[] = "'delete_protect_enabled' can't be null";
        }
