...
class SubnetInfoForDescribeInstanceDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubnetInfoForDescribeInstanceDetailOutput';
