...
class ChargeConfigForCreateInstanceOneStepInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeConfigForCreateInstanceOneStepInput';
