...
class SpecConfigForDescribeInstanceDetailOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SpecConfigForDescribeInstanceDetailOutput';
