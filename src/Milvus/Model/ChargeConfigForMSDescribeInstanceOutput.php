...
class ChargeConfigForMSDescribeInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChargeConfigForMSDescribeInstanceOutput';
