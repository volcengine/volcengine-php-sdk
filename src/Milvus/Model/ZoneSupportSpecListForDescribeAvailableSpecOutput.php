...
class ZoneSupportSpecListForDescribeAvailableSpecOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ZoneSupportSpecListForDescribeAvailableSpecOutput';
