...
class StorageSpecForDescribeNodeAvailableSpecsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageSpecForDescribeNodeAvailableSpecsOutput';
