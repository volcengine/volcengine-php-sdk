...
class SubnetForCreateInstanceInOneStepInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubnetForCreateInstanceInOneStepInput';
