...
class MasterNodeStorageSpecForDescribeInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MasterNodeStorageSpecForDescribeInstanceOutput';
