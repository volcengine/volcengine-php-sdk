...
class InstancePluginForDescribeInstancePluginsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InstancePluginForDescribeInstancePluginsOutput';
