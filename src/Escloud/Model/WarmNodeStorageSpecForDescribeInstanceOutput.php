...
class WarmNodeStorageSpecForDescribeInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WarmNodeStorageSpecForDescribeInstanceOutput';
