...
class StorageSpecForDescribeInstanceNodesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageSpecForDescribeInstanceNodesOutput';
