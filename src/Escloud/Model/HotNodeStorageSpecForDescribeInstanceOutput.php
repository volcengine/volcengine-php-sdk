...
class HotNodeStorageSpecForDescribeInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HotNodeStorageSpecForDescribeInstanceOutput';
