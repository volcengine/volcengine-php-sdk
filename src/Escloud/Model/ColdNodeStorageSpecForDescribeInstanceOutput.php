...
class ColdNodeStorageSpecForDescribeInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ColdNodeStorageSpecForDescribeInstanceOutput';
