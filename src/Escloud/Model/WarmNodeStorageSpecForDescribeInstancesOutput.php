...
class WarmNodeStorageSpecForDescribeInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WarmNodeStorageSpecForDescribeInstancesOutput';
