...
class CoordinatorNodeStorageSpecForDescribeInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CoordinatorNodeStorageSpecForDescribeInstanceOutput';
