...
class ExtraPerformanceForCreateInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExtraPerformanceForCreateInstanceInput';
