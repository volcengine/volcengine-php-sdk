...
class BackSrcQpsFlowForDescWebQpsFlowOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BackSrcQpsFlowForDescWebQpsFlowOutput';
