...
class GetFwdRuleLipListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetFwdRuleLipListRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['region_list'] === null) {
            $invalidProperties[] = "'region_list' can't be null";
        }
