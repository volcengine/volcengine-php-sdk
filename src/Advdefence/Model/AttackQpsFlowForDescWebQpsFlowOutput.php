...
class AttackQpsFlowForDescWebQpsFlowOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AttackQpsFlowForDescWebQpsFlowOutput';
