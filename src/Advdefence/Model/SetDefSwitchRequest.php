...
class SetDefSwitchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SetDefSwitchRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cc_enable'] === null) {
            $invalidProperties[] = "'cc_enable' can't be null";
        }
