...
class PeakInQpsFlowForDescWebQpsFlowOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PeakInQpsFlowForDescWebQpsFlowOutput';
