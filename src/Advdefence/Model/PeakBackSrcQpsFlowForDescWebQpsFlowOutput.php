...
class PeakBackSrcQpsFlowForDescWebQpsFlowOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PeakBackSrcQpsFlowForDescWebQpsFlowOutput';
