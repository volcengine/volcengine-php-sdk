...
class ModifyRouteEntryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyRouteEntryRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['route_entry_id'] === null) {
            $invalidProperties[] = "'route_entry_id' can't be null";
        }
