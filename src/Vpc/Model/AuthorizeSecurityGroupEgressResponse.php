...
class AuthorizeSecurityGroupEgressResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuthorizeSecurityGroupEgressResponse';
