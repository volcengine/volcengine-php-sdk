...
class AssociateIpamResourceDiscoveryRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AssociateIpamResourceDiscoveryRequest';
