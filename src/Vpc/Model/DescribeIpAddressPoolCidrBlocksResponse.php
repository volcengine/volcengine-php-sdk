...
class DescribeIpAddressPoolCidrBlocksResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeIpAddressPoolCidrBlocksResponse';
