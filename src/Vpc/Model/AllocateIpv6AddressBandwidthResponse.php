...
class AllocateIpv6AddressBandwidthResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AllocateIpv6AddressBandwidthResponse';
