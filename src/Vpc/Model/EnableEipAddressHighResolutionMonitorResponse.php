...
class EnableEipAddressHighResolutionMonitorResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EnableEipAddressHighResolutionMonitorResponse';
