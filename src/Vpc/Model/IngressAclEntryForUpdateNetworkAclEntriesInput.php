...
class IngressAclEntryForUpdateNetworkAclEntriesInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IngressAclEntryForUpdateNetworkAclEntriesInput';
