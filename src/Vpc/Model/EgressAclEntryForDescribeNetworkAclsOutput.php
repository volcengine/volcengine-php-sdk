...
class EgressAclEntryForDescribeNetworkAclsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EgressAclEntryForDescribeNetworkAclsOutput';
