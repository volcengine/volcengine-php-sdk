...
class ModifySecurityGroupRuleDescriptionsEgressRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifySecurityGroupRuleDescriptionsEgressRequest';
