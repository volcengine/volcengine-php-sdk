...
class EgressAclEntryForDescribeNetworkAclAttributesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EgressAclEntryForDescribeNetworkAclAttributesOutput';
