...
class Ipv6CidrBlockForAssociateVpcCidrBlockOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ipv6CidrBlockForAssociateVpcCidrBlockOutput';
