...
class EipAddressForDescribeBandwidthPackagesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EipAddressForDescribeBandwidthPackagesOutput';
