...
class DescribeIpamCloudMonitorDimensionsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DescribeIpamCloudMonitorDimensionsRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['target_name'] === null) {
            $invalidProperties[] = "'target_name' can't be null";
        }
