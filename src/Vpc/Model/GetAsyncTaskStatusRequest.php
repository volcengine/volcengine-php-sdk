...
class GetAsyncTaskStatusRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetAsyncTaskStatusRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['async_task_id'] === null) {
            $invalidProperties[] = "'async_task_id' can't be null";
        }
