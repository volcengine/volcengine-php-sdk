...
class ModifyTrafficMirrorSessionAttributesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyTrafficMirrorSessionAttributesResponse';
