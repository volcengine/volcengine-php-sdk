...
class DisableEipAddressHighResolutionMonitorRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DisableEipAddressHighResolutionMonitorRequest';
