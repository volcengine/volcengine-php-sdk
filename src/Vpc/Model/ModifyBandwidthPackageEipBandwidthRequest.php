...
class ModifyBandwidthPackageEipBandwidthRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyBandwidthPackageEipBandwidthRequest';
