...
class PrefixListEntryForDescribePrefixListEntriesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrefixListEntryForDescribePrefixListEntriesOutput';
