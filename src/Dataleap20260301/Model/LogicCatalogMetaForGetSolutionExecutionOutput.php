...
class LogicCatalogMetaForGetSolutionExecutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LogicCatalogMetaForGetSolutionExecutionOutput';
