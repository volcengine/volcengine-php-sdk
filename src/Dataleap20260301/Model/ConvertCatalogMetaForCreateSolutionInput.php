...
class ConvertCatalogMetaForCreateSolutionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertCatalogMetaForCreateSolutionInput';
