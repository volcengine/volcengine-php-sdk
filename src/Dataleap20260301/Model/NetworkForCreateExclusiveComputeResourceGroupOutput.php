...
class NetworkForCreateExclusiveComputeResourceGroupOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkForCreateExclusiveComputeResourceGroupOutput';
