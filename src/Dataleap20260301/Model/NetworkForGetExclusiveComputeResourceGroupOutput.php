...
class NetworkForGetExclusiveComputeResourceGroupOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkForGetExclusiveComputeResourceGroupOutput';
