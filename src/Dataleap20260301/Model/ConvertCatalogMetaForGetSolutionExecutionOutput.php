...
class ConvertCatalogMetaForGetSolutionExecutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertCatalogMetaForGetSolutionExecutionOutput';
