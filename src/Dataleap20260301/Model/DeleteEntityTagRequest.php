...
class DeleteEntityTagRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteEntityTagRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['qualified_name'] === null) {
            $invalidProperties[] = "'qualified_name' can't be null";
        }
