...
class LogicCatalogMetaForUpdateSolutionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LogicCatalogMetaForUpdateSolutionInput';
