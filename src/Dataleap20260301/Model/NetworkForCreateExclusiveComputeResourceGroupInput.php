...
class NetworkForCreateExclusiveComputeResourceGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkForCreateExclusiveComputeResourceGroupInput';
