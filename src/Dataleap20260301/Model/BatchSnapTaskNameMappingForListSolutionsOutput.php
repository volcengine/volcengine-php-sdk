...
class BatchSnapTaskNameMappingForListSolutionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchSnapTaskNameMappingForListSolutionsOutput';
