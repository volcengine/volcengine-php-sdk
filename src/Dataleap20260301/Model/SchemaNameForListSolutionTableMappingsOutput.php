...
class SchemaNameForListSolutionTableMappingsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SchemaNameForListSolutionTableMappingsOutput';
