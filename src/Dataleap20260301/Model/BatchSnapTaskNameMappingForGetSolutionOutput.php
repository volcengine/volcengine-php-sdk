...
class BatchSnapTaskNameMappingForGetSolutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchSnapTaskNameMappingForGetSolutionOutput';
