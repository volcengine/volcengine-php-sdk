...
class LogicCatalogMetaForUpdateSolutionTableMappingsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LogicCatalogMetaForUpdateSolutionTableMappingsInput';
