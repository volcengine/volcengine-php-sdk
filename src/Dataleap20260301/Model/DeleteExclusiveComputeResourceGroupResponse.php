...
class DeleteExclusiveComputeResourceGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteExclusiveComputeResourceGroupResponse';
