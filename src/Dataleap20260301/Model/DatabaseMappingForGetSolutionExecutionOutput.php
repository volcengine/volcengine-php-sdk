...
class DatabaseMappingForGetSolutionExecutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DatabaseMappingForGetSolutionExecutionOutput';
