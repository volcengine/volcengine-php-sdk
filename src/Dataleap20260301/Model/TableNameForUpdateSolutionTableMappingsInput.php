...
class TableNameForUpdateSolutionTableMappingsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TableNameForUpdateSolutionTableMappingsInput';
