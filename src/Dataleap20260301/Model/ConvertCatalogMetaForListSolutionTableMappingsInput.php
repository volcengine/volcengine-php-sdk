...
class ConvertCatalogMetaForListSolutionTableMappingsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertCatalogMetaForListSolutionTableMappingsInput';
