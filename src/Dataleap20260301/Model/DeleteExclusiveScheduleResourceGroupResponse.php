...
class DeleteExclusiveScheduleResourceGroupResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteExclusiveScheduleResourceGroupResponse';
