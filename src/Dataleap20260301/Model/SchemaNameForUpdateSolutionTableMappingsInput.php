...
class SchemaNameForUpdateSolutionTableMappingsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SchemaNameForUpdateSolutionTableMappingsInput';
