...
class BatchIncrTaskNameMappingForListSolutionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchIncrTaskNameMappingForListSolutionsOutput';
