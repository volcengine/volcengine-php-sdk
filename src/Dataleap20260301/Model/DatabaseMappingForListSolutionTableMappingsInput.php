...
class DatabaseMappingForListSolutionTableMappingsInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DatabaseMappingForListSolutionTableMappingsInput';
