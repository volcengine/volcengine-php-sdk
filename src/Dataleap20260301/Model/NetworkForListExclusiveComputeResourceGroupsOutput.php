...
class NetworkForListExclusiveComputeResourceGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NetworkForListExclusiveComputeResourceGroupsOutput';
