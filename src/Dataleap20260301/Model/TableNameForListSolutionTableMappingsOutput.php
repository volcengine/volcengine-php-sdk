...
class TableNameForListSolutionTableMappingsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TableNameForListSolutionTableMappingsOutput';
