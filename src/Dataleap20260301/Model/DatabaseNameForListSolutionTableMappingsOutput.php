...
class DatabaseNameForListSolutionTableMappingsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DatabaseNameForListSolutionTableMappingsOutput';
