...
class ConvertConvertConvertReaderForListSolutionsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertConvertConvertReaderForListSolutionsOutput';
