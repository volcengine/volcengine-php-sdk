...
class BatchIncrTaskNameMappingForCreateSolutionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchIncrTaskNameMappingForCreateSolutionInput';
