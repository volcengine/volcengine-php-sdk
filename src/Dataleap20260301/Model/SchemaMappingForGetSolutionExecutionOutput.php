...
class SchemaMappingForGetSolutionExecutionOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SchemaMappingForGetSolutionExecutionOutput';
