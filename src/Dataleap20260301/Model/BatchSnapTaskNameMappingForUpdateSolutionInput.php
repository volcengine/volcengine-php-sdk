...
class BatchSnapTaskNameMappingForUpdateSolutionInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BatchSnapTaskNameMappingForUpdateSolutionInput';
