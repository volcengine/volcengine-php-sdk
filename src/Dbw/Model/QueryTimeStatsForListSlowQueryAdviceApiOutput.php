...
class QueryTimeStatsForListSlowQueryAdviceApiOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryTimeStatsForListSlowQueryAdviceApiOutput';
