...
class LockTimeStatsForListSlowQueryAdviceApiOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LockTimeStatsForListSlowQueryAdviceApiOutput';
