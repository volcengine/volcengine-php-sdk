...
class RowsSentStatsForListSlowQueryAdviceApiOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RowsSentStatsForListSlowQueryAdviceApiOutput';
