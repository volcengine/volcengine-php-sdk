...
class GpuCountInfoForListResourceQueuesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GpuCountInfoForListResourceQueuesOutput';
