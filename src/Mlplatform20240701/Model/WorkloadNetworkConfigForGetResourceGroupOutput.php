...
class WorkloadNetworkConfigForGetResourceGroupOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkloadNetworkConfigForGetResourceGroupOutput';
