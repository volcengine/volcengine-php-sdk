...
class SfcsAdvancedOptionsForCreateDevInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SfcsAdvancedOptionsForCreateDevInstanceInput';
