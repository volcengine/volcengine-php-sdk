...
class ComputeResourceForUpdateResourceGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ComputeResourceForUpdateResourceGroupInput';
