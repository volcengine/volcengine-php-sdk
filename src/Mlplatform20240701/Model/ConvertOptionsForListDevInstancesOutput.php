...
class ConvertOptionsForListDevInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertOptionsForListDevInstancesOutput';
