...
class FlexibleResourceClaimForGetDeploymentOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlexibleResourceClaimForGetDeploymentOutput';
