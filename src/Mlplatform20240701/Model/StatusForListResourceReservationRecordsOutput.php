...
class StatusForListResourceReservationRecordsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StatusForListResourceReservationRecordsOutput';
