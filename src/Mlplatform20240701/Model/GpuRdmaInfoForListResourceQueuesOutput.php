...
class GpuRdmaInfoForListResourceQueuesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GpuRdmaInfoForListResourceQueuesOutput';
