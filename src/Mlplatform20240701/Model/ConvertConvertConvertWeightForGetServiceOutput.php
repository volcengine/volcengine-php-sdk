...
class ConvertConvertConvertWeightForGetServiceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertConvertConvertWeightForGetServiceOutput';
