...
class LivenessProbeForUpdateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LivenessProbeForUpdateDeploymentInput';
