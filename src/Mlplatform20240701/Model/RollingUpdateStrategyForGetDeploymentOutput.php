...
class RollingUpdateStrategyForGetDeploymentOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RollingUpdateStrategyForGetDeploymentOutput';
