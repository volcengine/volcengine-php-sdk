...
class GeneralIdleRuleForGetResourceQueueOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GeneralIdleRuleForGetResourceQueueOutput';
