...
class VolumeSizeInfoForGetResourceQueueOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VolumeSizeInfoForGetResourceQueueOutput';
