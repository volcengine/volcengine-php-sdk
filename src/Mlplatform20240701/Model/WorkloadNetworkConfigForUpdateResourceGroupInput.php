...
class WorkloadNetworkConfigForUpdateResourceGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkloadNetworkConfigForUpdateResourceGroupInput';
