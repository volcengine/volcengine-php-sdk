...
class ConvertCredentialForGetDevInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertCredentialForGetDevInstanceOutput';
