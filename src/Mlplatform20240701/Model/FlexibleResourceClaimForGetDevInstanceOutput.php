...
class FlexibleResourceClaimForGetDevInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlexibleResourceClaimForGetDevInstanceOutput';
