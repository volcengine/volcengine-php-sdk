...
class SfcsAdvancedOptionsForUpdateDevInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SfcsAdvancedOptionsForUpdateDevInstanceInput';
