...
class GpuUtilizationRuleForCreateResourceQueueInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GpuUtilizationRuleForCreateResourceQueueInput';
