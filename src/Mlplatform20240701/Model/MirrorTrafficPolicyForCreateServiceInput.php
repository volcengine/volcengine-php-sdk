...
class MirrorTrafficPolicyForCreateServiceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MirrorTrafficPolicyForCreateServiceInput';
