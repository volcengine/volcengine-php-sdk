...
class SfcsAdvancedOptionsForUpdateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SfcsAdvancedOptionsForUpdateDeploymentInput';
