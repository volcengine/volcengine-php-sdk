...
class ComputeResourceForCreateResourceGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ComputeResourceForCreateResourceGroupInput';
