...
class WorkloadNetworkConfigForListResourceGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkloadNetworkConfigForListResourceGroupsOutput';
