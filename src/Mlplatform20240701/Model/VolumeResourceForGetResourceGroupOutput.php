...
class VolumeResourceForGetResourceGroupOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VolumeResourceForGetResourceGroupOutput';
