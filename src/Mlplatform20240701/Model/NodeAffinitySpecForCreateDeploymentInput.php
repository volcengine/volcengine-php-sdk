...
class NodeAffinitySpecForCreateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeAffinitySpecForCreateDeploymentInput';
