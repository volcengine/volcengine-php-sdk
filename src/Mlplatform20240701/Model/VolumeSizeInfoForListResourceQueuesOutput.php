...
class VolumeSizeInfoForListResourceQueuesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VolumeSizeInfoForListResourceQueuesOutput';
