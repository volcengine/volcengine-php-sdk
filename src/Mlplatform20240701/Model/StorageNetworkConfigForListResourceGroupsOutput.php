...
class StorageNetworkConfigForListResourceGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageNetworkConfigForListResourceGroupsOutput';
