...
class RollingUpdateStrategyForCreateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RollingUpdateStrategyForCreateDeploymentInput';
