...
class VolumeResourceForGetResourceQueueOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VolumeResourceForGetResourceQueueOutput';
