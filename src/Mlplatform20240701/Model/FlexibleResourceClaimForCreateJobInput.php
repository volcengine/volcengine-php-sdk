...
class FlexibleResourceClaimForCreateJobInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlexibleResourceClaimForCreateJobInput';
