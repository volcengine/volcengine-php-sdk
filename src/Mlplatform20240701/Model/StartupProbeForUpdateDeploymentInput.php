...
class StartupProbeForUpdateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StartupProbeForUpdateDeploymentInput';
