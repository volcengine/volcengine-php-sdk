...
class AdvancedOptionsForUpdateDevInstanceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AdvancedOptionsForUpdateDevInstanceInput';
