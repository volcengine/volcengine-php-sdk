...
class ConsistentHashConfigForUpdateServiceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConsistentHashConfigForUpdateServiceInput';
