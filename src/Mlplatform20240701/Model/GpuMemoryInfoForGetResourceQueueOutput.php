...
class GpuMemoryInfoForGetResourceQueueOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GpuMemoryInfoForGetResourceQueueOutput';
