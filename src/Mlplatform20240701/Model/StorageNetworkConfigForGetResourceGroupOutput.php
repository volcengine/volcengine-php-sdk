...
class StorageNetworkConfigForGetResourceGroupOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageNetworkConfigForGetResourceGroupOutput';
