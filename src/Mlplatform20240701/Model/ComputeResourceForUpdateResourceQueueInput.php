...
class ComputeResourceForUpdateResourceQueueInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ComputeResourceForUpdateResourceQueueInput';
