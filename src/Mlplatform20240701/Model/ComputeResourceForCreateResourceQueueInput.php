...
class ComputeResourceForCreateResourceQueueInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ComputeResourceForCreateResourceQueueInput';
