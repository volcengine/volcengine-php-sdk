...
class FlexibleResourceClaimForListJobInstancesOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlexibleResourceClaimForListJobInstancesOutput';
