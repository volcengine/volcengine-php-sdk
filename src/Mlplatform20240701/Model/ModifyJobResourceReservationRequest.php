...
class ModifyJobResourceReservationRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ModifyJobResourceReservationRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['resource_reservation'] === null) {
            $invalidProperties[] = "'resource_reservation' can't be null";
        }
