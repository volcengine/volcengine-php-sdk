...
class FlexibleResourceClaimForUpdateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FlexibleResourceClaimForUpdateDeploymentInput';
