...
class ConsistentHashConfigForGetServiceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConsistentHashConfigForGetServiceOutput';
