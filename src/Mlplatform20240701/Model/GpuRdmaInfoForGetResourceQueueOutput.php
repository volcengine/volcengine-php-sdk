...
class GpuRdmaInfoForGetResourceQueueOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GpuRdmaInfoForGetResourceQueueOutput';
