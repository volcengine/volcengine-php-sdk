...
class ResourceAllocatedForListResourceGroupsOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceAllocatedForListResourceGroupsOutput';
