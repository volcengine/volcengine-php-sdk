...
class AdvancedOptionsForCreateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AdvancedOptionsForCreateDeploymentInput';
