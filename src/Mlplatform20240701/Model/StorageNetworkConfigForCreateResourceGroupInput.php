...
class StorageNetworkConfigForCreateResourceGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageNetworkConfigForCreateResourceGroupInput';
