...
class LivenessProbeForCreateDeploymentInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LivenessProbeForCreateDeploymentInput';
