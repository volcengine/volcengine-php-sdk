...
class MirrorTrafficPolicyForUpdateServiceInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MirrorTrafficPolicyForUpdateServiceInput';
