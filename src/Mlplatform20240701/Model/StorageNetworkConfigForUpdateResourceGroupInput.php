...
class StorageNetworkConfigForUpdateResourceGroupInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StorageNetworkConfigForUpdateResourceGroupInput';
