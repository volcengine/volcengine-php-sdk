...
class ConvertOptionsForGetDeploymentOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertOptionsForGetDeploymentOutput';
