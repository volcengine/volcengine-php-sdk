...
class NodeAffinitySpecForGetDevInstanceOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NodeAffinitySpecForGetDevInstanceOutput';
