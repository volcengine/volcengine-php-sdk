...
class PodMuteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PodMuteRequest';
    ...
    {
        $this->container['display_list'] = isset($data['display_list']) ? $data['display_list'] : null;
    ...
    {
        return $this->container['display_list'];
    }

    /**
     * Sets display_list
     *
     * @param string[] $display_list display_list
     *
     * @return $this
     */
    public function setDisplayList($display_list)
    {
        $this->container['display_list'] = $display_list;
