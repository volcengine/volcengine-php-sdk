...
class UpdatePhoneTemplateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdatePhoneTemplateRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['phone_template_id'] === null) {
            $invalidProperties[] = "'phone_template_id' can't be null";
        }
