...
class ErrorPodInfoListForUnbindPortMappingRuleOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ErrorPodInfoListForUnbindPortMappingRuleOutput';
