...
class ConvertLatestVersionForDetailAppOutput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConvertLatestVersionForDetailAppOutput';
