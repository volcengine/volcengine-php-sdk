...
class UpdateCustomRouteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateCustomRouteRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['custom_route_id'] === null) {
            $invalidProperties[] = "'custom_route_id' can't be null";
        }
